...
export const Vphysics2Dll = {
    ...
    RnSphereDesc_t : {
        m_Sphere : 0x18, // RnSphere_t
    },
    RnCompoundDesc_t : {
        m_Compound : 0x18, // RnCompound_t
    },
    ...
    PhysFeModelDesc_t : {
        ...
        m_Prisms : 0xF0, // CUtlVector<FePrism_t>
        m_SimdPrisms : 0x108, // CUtlVector<FeSimdPrism_t>
        m_SimdRods : 0x120, // CUtlVector<FeSimdRodConstraint_t>
        m_SimdRodsAnim : 0x138, // CUtlVector<FeSimdRodConstraintAnim_t>
        m_InitPose : 0x150, // CUtlVector<CTransform>
        m_Rods : 0x168, // CUtlVector<FeRodConstraint_t>
        m_Twists : 0x180, // CUtlVector<FeTwistConstraint_t>
        m_HingeLimits : 0x198, // CUtlVector<FeHingeLimit_t>
        m_AntiTunnelBytecode : 0x1B0, // CUtlVector<uint32>
        m_DynKinLinks : 0x1C8, // CUtlVector<FeDynKinLink_t>
        m_BoneMergeLinks : 0x1E0, // CUtlVector<FeBoneMergeLink_t>
        m_AntiTunnelProbes : 0x1F8, // CUtlVector<FeAntiTunnelProbe_t>
        m_AntiTunnelTargetNodes : 0x210, // CUtlVector<uint16>
        m_NodeStrayBoxes : 0x228, // CUtlVector<FeNodeStrayBox_t>
        m_AxialEdges : 0x240, // CUtlVector<FeAxialEdgeBend_t>
        m_NodeInvMasses : 0x258, // CUtlVector<float32>
        m_CtrlOffsets : 0x270, // CUtlVector<FeCtrlOffset_t>
        m_CtrlOsOffsets : 0x288, // CUtlVector<FeCtrlOsOffset_t>
        m_FollowNodes : 0x2A0, // CUtlVector<FeFollowNode_t>
        m_CollisionPlanes : 0x2B8, // CUtlVector<FeCollisionPlane_t>
        m_NodeIntegrator : 0x2D0, // CUtlVector<FeNodeIntegrator_t>
        m_SpringIntegrator : 0x2E8, // CUtlVector<FeSpringIntegrator_t>
        m_SimdSpringIntegrator : 0x300, // CUtlVector<FeSimdSpringIntegrator_t>
        m_WorldCollisionParams : 0x318, // CUtlVector<FeWorldCollisionParams_t>
        m_LegacyStretchForce : 0x330, // CUtlVector<float32>
        m_NodeCollisionRadii : 0x348, // CUtlVector<float32>
        m_DynNodeFriction : 0x360, // CUtlVector<float32>
        m_LocalRotation : 0x378, // CUtlVector<float32>
        m_LocalForce : 0x390, // CUtlVector<float32>
        m_TaperedCapsuleStretches : 0x3A8, // CUtlVector<FeTaperedCapsuleStretch_t>
        m_TaperedCapsuleRigids : 0x3C0, // CUtlVector<FeTaperedCapsuleRigid_t>
        m_SphereRigids : 0x3D8, // CUtlVector<FeSphereRigid_t>
        m_WorldCollisionNodes : 0x3F0, // CUtlVector<uint16>
        m_TreeParents : 0x408, // CUtlVector<uint16>
        m_TreeCollisionMasks : 0x420, // CUtlVector<uint16>
        m_TreeChildren : 0x438, // CUtlVector<FeTreeChildren_t>
        m_FreeNodes : 0x450, // CUtlVector<uint16>
        m_FitMatrices : 0x468, // CUtlVector<FeFitMatrix_t>
        m_FitWeights : 0x480, // CUtlVector<FeFitWeight_t>
        m_ReverseOffsets : 0x498, // CUtlVector<FeNodeReverseOffset_t>
        m_AnimStrayRadii : 0x4B0, // CUtlVector<FeAnimStrayRadius_t>
        m_SimdAnimStrayRadii : 0x4C8, // CUtlVector<FeSimdAnimStrayRadius_t>
        m_KelagerBends : 0x4E0, // CUtlVector<FeKelagerBend2_t>
        m_CtrlSoftOffsets : 0x4F8, // CUtlVector<FeCtrlSoftOffset_t>
        m_JiggleBones : 0x510, // CUtlVector<CFeIndexedJiggleBone>
        m_SourceElems : 0x528, // CUtlVector<uint16>
        m_GoalDampedSpringIntegrators : 0x540, // CUtlVector<uint32>
        m_Tris : 0x558, // CUtlVector<FeTri_t>
        m_nTriCount1 : 0x570, // uint16
        m_nTriCount2 : 0x572, // uint16
        m_nReservedUint8 : 0x574, // uint8
        m_nExtraPressureIterations : 0x575, // uint8
        m_nExtraGoalIterations : 0x576, // uint8
        m_nExtraIterations : 0x577, // uint8
        m_SDFRigids : 0x578, // CUtlVector<FeSDFRigid_t>
        m_BoxRigids : 0x590, // CUtlVector<FeBoxRigid_t>
        m_DynNodeVertexSet : 0x5A8, // CUtlVector<uint8>
        m_VertexSetNames : 0x5C0, // CUtlVector<uint32>
        m_RigidColliderPriorities : 0x5D8, // CUtlVector<FeRigidColliderIndices_t>
        m_MorphLayers : 0x5F0, // CUtlVector<FeMorphLayerDepr_t>
        m_MorphSetData : 0x608, // CUtlVector<uint8>
        m_VertexMaps : 0x620, // CUtlVector<FeVertexMapDesc_t>
        m_VertexMapValues : 0x638, // CUtlVector<uint8>
        m_Effects : 0x650, // CUtlVector<FeEffectDesc_t>
        m_LockToParent : 0x668, // CUtlVector<FeCtrlOffset_t>
        m_LockToGoal : 0x680, // CUtlVector<uint16>
        m_SkelParents : 0x698, // CUtlVector<int16>
        m_DynNodeWindBases : 0x6B0, // CUtlVector<FeNodeWindBase_t>
        m_SelfCollisionLayers : 0x6C8, // CUtlVector<FeModelSelfCollisionLayer_t>
        m_flInternalPressure : 0x6E0, // float32
        m_flDefaultTimeDilation : 0x6E4, // float32
        m_flWindage : 0x6E8, // float32
        m_flWindDrag : 0x6EC, // float32
        m_flDefaultSurfaceStretch : 0x6F0, // float32
        m_flDefaultThreadStretch : 0x6F4, // float32
        m_flDefaultGravityScale : 0x6F8, // float32
        m_flDefaultVelAirDrag : 0x6FC, // float32
        m_flDefaultExpAirDrag : 0x700, // float32
        m_flDefaultVelQuadAirDrag : 0x704, // float32
        m_flDefaultExpQuadAirDrag : 0x708, // float32
        m_flRodVelocitySmoothRate : 0x70C, // float32
        m_flQuadVelocitySmoothRate : 0x710, // float32
        m_flAddWorldCollisionRadius : 0x714, // float32
        m_flDefaultVolumetricSolveAmount : 0x718, // float32
        m_flMotionSmoothCDT : 0x71C, // float32
        m_flLocalDrag1 : 0x720, // float32
        m_nRodVelocitySmoothIterations : 0x724, // uint16
        m_nQuadVelocitySmoothIterations : 0x726, // uint16
    },
    RnMeshDesc_t : {
    ...
    FeBoneMergeLink_t : {
        m_nParentHash : 0x0, // uint32
        m_nChildNode : 0x4, // uint16
    },
    ...
    RnCompoundTree_t : {
        m_Nodes : 0x0, // CUtlLeanVector<RnCompoundTreeNode_t>
        m_nStartIterationIndex : 0x10, // uint32
    },
    ...
    RnCompoundTreeNode_t : {
        m_vMin : 0x0, // Vector
        m_vMax : 0xC, // Vector
        m_nType : 0x0, // bitfield:3
        m_nSubtreeEndOrCompoundId : 0x0, // bitfield:29
    },
    FeBuildSDFRigid_t : {
    ...
    RnCompound_t : {
        m_Tree : 0x0, // RnCompoundTree_t
        m_nHullBaseIndex : 0x18, // int32
        m_nMeshBaseIndex : 0x1C, // int32
        m_nShapeCount : 0x20, // int32
        m_Meshes : 0x28, // CUtlLeanVectorFixedGrowable<RnMesh_t,1>
        m_Hulls : 0xF0, // CUtlLeanVector<RnHull_t>
        m_Capsules : 0x100, // CUtlLeanVector<RnCapsule_t>
        m_Spheres : 0x110, // CUtlLeanVector<RnSphere_t>
        m_CompoundMaterialIndices : 0x120, // CUtlLeanVector<uint8>
        m_Bounds : 0x130, // AABB_t
        m_vOrthographicAreas : 0x148, // Vector
        m_flSurfaceArea : 0x154, // float32
        m_flVolume : 0x158, // float32
    },
    FeVertexMapDesc_t : {
    ...
    RnHull_t : {
        ...
        m_flMinCentroidRadius : 0x10, // float32
        m_Bounds : 0x14, // AABB_t
        m_vOrthographicAreas : 0x2C, // Vector
        m_MassProperties : 0x38, // matrix3x4_t
        m_flVolume : 0x68, // float32
        m_flSurfaceArea : 0x6C, // float32
        m_VertexPositions : 0x70, // CUtlVector<Vector>
        m_FacePlanes : 0x88, // CUtlVector<RnPlane_t>
        m_nFlags : 0xA0, // uint32
        m_pRegionSVM : 0xA8, // CRegionSVM*
        m_Vertices : 0xB0, // CUtlVector<RnVertex_t>
        m_Edges : 0xC8, // CUtlVector<RnHalfEdge_t>
        m_Faces : 0xE0, // CUtlVector<RnFace_t>
    },
