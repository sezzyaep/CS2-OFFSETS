...
{
	constexpr uint32_t m_pBulletServices = 0x1470;
	constexpr uint32_t m_pHostageServices = 0x1478;
	constexpr uint32_t m_pBuyServices = 0x1480;
	constexpr uint32_t m_pGlowServices = 0x1488;
	constexpr uint32_t m_pActionTrackingServices = 0x1490;
	constexpr uint32_t m_flHealthShotBoostExpirationTime = 0x1498;
	constexpr uint32_t m_flLastFiredWeaponTime = 0x149C;
	constexpr uint32_t m_bHasFemaleVoice = 0x14A0;
	constexpr uint32_t m_flLandingTimeSeconds = 0x14A4;
	constexpr uint32_t m_flOldFallVelocity = 0x14A8;
	constexpr uint32_t m_szLastPlaceName = 0x14AC;
	constexpr uint32_t m_bPrevDefuser = 0x14BE;
	constexpr uint32_t m_bPrevHelmet = 0x14BF;
	constexpr uint32_t m_nPrevArmorVal = 0x14C0;
	constexpr uint32_t m_nPrevGrenadeAmmoCount = 0x14C4;
	constexpr uint32_t m_unPreviousWeaponHash = 0x14C8;
	constexpr uint32_t m_unWeaponHash = 0x14CC;
	constexpr uint32_t m_bInBuyZone = 0x14D0;
	constexpr uint32_t m_bPreviouslyInBuyZone = 0x14D1;
	constexpr uint32_t m_aimPunchAngle = 0x14D4;
	constexpr uint32_t m_aimPunchAngleVel = 0x14E0;
	constexpr uint32_t m_aimPunchTickBase = 0x14EC;
	constexpr uint32_t m_aimPunchTickFraction = 0x14F0;
	constexpr uint32_t m_aimPunchCache = 0x14F8;
	constexpr uint32_t m_bInLanding = 0x1518;
	constexpr uint32_t m_flLandingStartTime = 0x151C;
	constexpr uint32_t m_bInHostageRescueZone = 0x1520;
	constexpr uint32_t m_bInBombZone = 0x1521;
	constexpr uint32_t m_bIsBuyMenuOpen = 0x1522;
...
{
	constexpr uint32_t m_hDetectParentChange = 0x1468;
}
...
{
	constexpr uint32_t m_bShouldFrontFaceCullLeftHanded = 0xED8;
}
...
{
	constexpr uint32_t m_bShouldIgnoreOffsetAndAccuracy = 0xF70;
	constexpr uint32_t m_nWeaponParity = 0xF74;
	constexpr uint32_t m_nOldWeaponParity = 0xF78;
	constexpr uint32_t m_nLastKnownAssociatedWeaponEntIndex = 0xF7C;
	constexpr uint32_t m_bNeedToQueueHighResComposite = 0xF80;
	constexpr uint32_t m_vLoweredWeaponOffset = 0xFD0;
}
...
namespace C_CSWeaponBase
{
	...
	constexpr uint32_t m_iMostRecentTeamNumber = 0x1758;
	constexpr uint32_t m_bDroppedNearBuyZone = 0x175C;
	constexpr uint32_t m_flNextAttackRenderTimeOffset = 0x1760;
	constexpr uint32_t m_bVisualsDataSet = 0x17E8;
	constexpr uint32_t m_bOldFirstPersonSpectatedState = 0x17E9;
...
{
	constexpr uint32_t m_pPingServices = 0x12B8;
	constexpr uint32_t m_pViewModelServices = 0x12C0;
	constexpr uint32_t m_fRenderingClipPlane = 0x12C8;
	constexpr uint32_t m_nLastClipPlaneSetupFrame = 0x12D8;
	constexpr uint32_t m_vecLastClipCameraPos = 0x12DC;
	constexpr uint32_t m_vecLastClipCameraForward = 0x12E8;
	constexpr uint32_t m_bClipHitStaticWorld = 0x12F4;
	constexpr uint32_t m_bCachedPlaneIsValid = 0x12F5;
	constexpr uint32_t m_pClippingWeapon = 0x12F8;
	constexpr uint32_t m_previousPlayerState = 0x1300;
	constexpr uint32_t m_iPlayerState = 0x1304;
	constexpr uint32_t m_bIsRescuing = 0x1308;
	constexpr uint32_t m_fImmuneToGunGameDamageTime = 0x130C;
	constexpr uint32_t m_fImmuneToGunGameDamageTimeLast = 0x1310;
	constexpr uint32_t m_bGunGameImmunity = 0x1314;
	constexpr uint32_t m_bHasMovedSinceSpawn = 0x1315;
	constexpr uint32_t m_fMolotovUseTime = 0x1318;
	constexpr uint32_t m_fMolotovDamageTime = 0x131C;
	constexpr uint32_t m_iThrowGrenadeCounter = 0x1320;
	constexpr uint32_t m_flLastSpawnTimeIndex = 0x1324;
	constexpr uint32_t m_iProgressBarDuration = 0x1328;
	constexpr uint32_t m_flProgressBarStartTime = 0x132C;
	constexpr uint32_t m_vecIntroStartEyePosition = 0x1330;
	constexpr uint32_t m_vecIntroStartPlayerForward = 0x133C;
	constexpr uint32_t m_flClientDeathTime = 0x1348;
	constexpr uint32_t m_bScreenTearFrameCaptured = 0x134C;
	constexpr uint32_t m_flFlashBangTime = 0x1350;
	constexpr uint32_t m_flFlashScreenshotAlpha = 0x1354;
	constexpr uint32_t m_flFlashOverlayAlpha = 0x1358;
	constexpr uint32_t m_bFlashBuildUp = 0x135C;
	constexpr uint32_t m_bFlashDspHasBeenCleared = 0x135D;
	constexpr uint32_t m_bFlashScreenshotHasBeenGrabbed = 0x135E;
	constexpr uint32_t m_flFlashMaxAlpha = 0x1360;
	constexpr uint32_t m_flFlashDuration = 0x1364;
	constexpr uint32_t m_iHealthBarRenderMaskIndex = 0x1368;
	constexpr uint32_t m_flHealthFadeValue = 0x136C;
	constexpr uint32_t m_flHealthFadeAlpha = 0x1370;
	constexpr uint32_t m_flDeathCCWeight = 0x1380;
	constexpr uint32_t m_flPrevRoundEndTime = 0x1384;
	constexpr uint32_t m_flPrevMatchEndTime = 0x1388;
	constexpr uint32_t m_angEyeAngles = 0x1390;
	constexpr uint32_t m_fNextThinkPushAway = 0x13A8;
	constexpr uint32_t m_bShouldAutobuyDMWeapons = 0x13AC;
	constexpr uint32_t m_bShouldAutobuyNow = 0x13AD;
	constexpr uint32_t m_bHud_MiniScoreHidden = 0x13AE;
	constexpr uint32_t m_bHud_RadarHidden = 0x13AF;
	constexpr uint32_t m_iIDEntIndex = 0x13B0;
	constexpr uint32_t m_delayTargetIDTimer = 0x13B8;
	constexpr uint32_t m_iTargetedWeaponEntIndex = 0x13D0;
	constexpr uint32_t m_iOldIDEntIndex = 0x13D4;
	constexpr uint32_t m_holdTargetIDTimer = 0x13D8;
	constexpr uint32_t m_flCurrentMusicStartTime = 0x13F4;
	constexpr uint32_t m_flMusicRoundStartTime = 0x13F8;
	constexpr uint32_t m_bDeferStartMusicOnWarmup = 0x13FC;
	constexpr uint32_t m_cycleLatch = 0x1400;
	constexpr uint32_t m_serverIntendedCycle = 0x1404;
	constexpr uint32_t m_flLastSmokeOverlayAlpha = 0x1408;
	constexpr uint32_t m_flLastSmokeAge = 0x140C;
	constexpr uint32_t m_vLastSmokeOverlayColor = 0x1410;
	constexpr uint32_t m_nPlayerSmokedFx = 0x141C;
	constexpr uint32_t m_nPlayerInfernoBodyFx = 0x1420;
	constexpr uint32_t m_nPlayerInfernoFootFx = 0x1424;
	constexpr uint32_t m_flNextMagDropTime = 0x1428;
	constexpr uint32_t m_nLastMagDropAttachmentIndex = 0x142C;
	constexpr uint32_t m_vecLastAliveLocalVelocity = 0x1430;
	constexpr uint32_t m_bGuardianShouldSprayCustomXMark = 0x1458;
	constexpr uint32_t m_hOriginalController = 0x1460;
}
