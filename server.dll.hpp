...
namespace CCSGameRules
{
	...
	constexpr uint32_t m_fAvgPlayerRank = 0xE1C;
...
{
	constexpr uint32_t m_pBulletServices = 0xD30;
	constexpr uint32_t m_pHostageServices = 0xD38;
	constexpr uint32_t m_pBuyServices = 0xD40;
	constexpr uint32_t m_pActionTrackingServices = 0xD48;
	constexpr uint32_t m_pRadioServices = 0xD50;
	constexpr uint32_t m_pDamageReactServices = 0xD58;
	constexpr uint32_t m_nCharacterDefIndex = 0xD60;
	constexpr uint32_t m_bHasFemaleVoice = 0xD62;
	constexpr uint32_t m_strVOPrefix = 0xD68;
	constexpr uint32_t m_szLastPlaceName = 0xD70;
	constexpr uint32_t m_bInHostageResetZone = 0xE38;
	constexpr uint32_t m_bInBuyZone = 0xE39;
	constexpr uint32_t m_TouchingBuyZones = 0xE40;
	constexpr uint32_t m_bWasInBuyZone = 0xE58;
	constexpr uint32_t m_bInHostageRescueZone = 0xE59;
	constexpr uint32_t m_bInBombZone = 0xE5A;
	constexpr uint32_t m_bWasInHostageRescueZone = 0xE5B;
	constexpr uint32_t m_iRetakesOffering = 0xE5C;
	constexpr uint32_t m_iRetakesOfferingCard = 0xE60;
	constexpr uint32_t m_bRetakesHasDefuseKit = 0xE64;
	constexpr uint32_t m_bRetakesMVPLastRound = 0xE65;
	constexpr uint32_t m_iRetakesMVPBoostItem = 0xE68;
	constexpr uint32_t m_RetakesMVPBoostExtraUtility = 0xE6C;
	constexpr uint32_t m_flHealthShotBoostExpirationTime = 0xE70;
	constexpr uint32_t m_flLandingTimeSeconds = 0xE74;
	constexpr uint32_t m_aimPunchAngle = 0xE78;
	constexpr uint32_t m_aimPunchAngleVel = 0xE84;
	constexpr uint32_t m_aimPunchTickBase = 0xE90;
	constexpr uint32_t m_aimPunchTickFraction = 0xE94;
	constexpr uint32_t m_aimPunchCache = 0xE98;
	constexpr uint32_t m_bIsBuyMenuOpen = 0xEB0;
	constexpr uint32_t m_xLastHeadBoneTransform = 0x14F0;
	constexpr uint32_t m_bLastHeadBoneTransformIsValid = 0x1510;
	constexpr uint32_t m_lastLandTime = 0x1514;
	constexpr uint32_t m_bOnGroundLastTick = 0x1518;
	constexpr uint32_t m_iPlayerLocked = 0x151C;
	constexpr uint32_t m_flTimeOfLastInjury = 0x1524;
	constexpr uint32_t m_flNextSprayDecalTime = 0x1528;
	constexpr uint32_t m_bNextSprayDecalTimeExpedited = 0x152C;
	constexpr uint32_t m_nRagdollDamageBone = 0x1530;
	constexpr uint32_t m_vRagdollDamageForce = 0x1534;
	constexpr uint32_t m_vRagdollDamagePosition = 0x1540;
	constexpr uint32_t m_szRagdollDamageWeaponName = 0x154C;
	constexpr uint32_t m_bRagdollDamageHeadshot = 0x158C;
	constexpr uint32_t m_vRagdollServerOrigin = 0x1590;
	constexpr uint32_t m_EconGloves = 0x15A0;
	constexpr uint32_t m_nEconGlovesChanged = 0x1818;
	constexpr uint32_t m_qDeathEyeAngles = 0x181C;
	constexpr uint32_t m_bSkipOneHeadConstraintUpdate = 0x1828;
	constexpr uint32_t m_bLeftHanded = 0x1829;
	constexpr uint32_t m_fSwitchedHandednessTime = 0x182C;
	constexpr uint32_t m_flViewmodelOffsetX = 0x1830;
	constexpr uint32_t m_flViewmodelOffsetY = 0x1834;
	constexpr uint32_t m_flViewmodelOffsetZ = 0x1838;
	constexpr uint32_t m_flViewmodelFOV = 0x183C;
	constexpr uint32_t m_bIsWalking = 0x1840;
	constexpr uint32_t m_fLastGivenDefuserTime = 0x1844;
	constexpr uint32_t m_fLastGivenBombTime = 0x1848;
	constexpr uint32_t m_flDealtDamageToEnemyMostRecentTimestamp = 0x184C;
	constexpr uint32_t m_iDisplayHistoryBits = 0x1850;
	constexpr uint32_t m_flLastAttackedTeammate = 0x1854;
	constexpr uint32_t m_allowAutoFollowTime = 0x1858;
	constexpr uint32_t m_bResetArmorNextSpawn = 0x185C;
	constexpr uint32_t m_nLastKillerIndex = 0x1860;
	constexpr uint32_t m_entitySpottedState = 0x1868;
	constexpr uint32_t m_nSpotRules = 0x1880;
	constexpr uint32_t m_bIsScoped = 0x1884;
	constexpr uint32_t m_bResumeZoom = 0x1885;
	constexpr uint32_t m_bIsDefusing = 0x1886;
	constexpr uint32_t m_bIsGrabbingHostage = 0x1887;
	constexpr uint32_t m_iBlockingUseActionInProgress = 0x1888;
	constexpr uint32_t m_flEmitSoundTime = 0x188C;
	constexpr uint32_t m_bInNoDefuseArea = 0x1890;
	constexpr uint32_t m_iBombSiteIndex = 0x1894;
	constexpr uint32_t m_nWhichBombZone = 0x1898;
	constexpr uint32_t m_bInBombZoneTrigger = 0x189C;
	constexpr uint32_t m_bWasInBombZoneTrigger = 0x189D;
	constexpr uint32_t m_iShotsFired = 0x18A0;
	constexpr uint32_t m_flFlinchStack = 0x18A4;
	constexpr uint32_t m_flVelocityModifier = 0x18A8;
	constexpr uint32_t m_flHitHeading = 0x18AC;
	constexpr uint32_t m_nHitBodyPart = 0x18B0;
	constexpr uint32_t m_vecTotalBulletForce = 0x18B4;
	constexpr uint32_t m_bWaitForNoAttack = 0x18C0;
	constexpr uint32_t m_ignoreLadderJumpTime = 0x18C4;
	constexpr uint32_t m_NumEnemiesKilledThisRound = 0x18C8;
	constexpr uint32_t m_bKilledByHeadshot = 0x18CC;
	constexpr uint32_t m_LastHitBox = 0x18D0;
	constexpr uint32_t m_LastHealth = 0x18D4;
	constexpr uint32_t m_pBot = 0x18D8;
	constexpr uint32_t m_bBotAllowActive = 0x18E0;
	constexpr uint32_t m_thirdPersonHeading = 0x18E4;
	constexpr uint32_t m_flSlopeDropOffset = 0x18F0;
	constexpr uint32_t m_flSlopeDropHeight = 0x18F4;
	constexpr uint32_t m_vHeadConstraintOffset = 0x18F8;
	constexpr uint32_t m_nLastPickupPriority = 0x1904;
	constexpr uint32_t m_flLastPickupPriorityTime = 0x1908;
	constexpr uint32_t m_ArmorValue = 0x190C;
	constexpr uint32_t m_unCurrentEquipmentValue = 0x1910;
	constexpr uint32_t m_unRoundStartEquipmentValue = 0x1912;
	constexpr uint32_t m_unFreezetimeEndEquipmentValue = 0x1914;
	constexpr uint32_t m_iLastWeaponFireUsercmd = 0x1918;
	constexpr uint32_t m_flLastFriendlyFireDamageReductionRatio = 0x191C;
	constexpr uint32_t m_bIsSpawning = 0x1920;
	constexpr uint32_t m_iDeathFlags = 0x1930;
	constexpr uint32_t m_bHasDeathInfo = 0x1934;
	constexpr uint32_t m_flDeathInfoTime = 0x1938;
	constexpr uint32_t m_vecDeathInfoOrigin = 0x193C;
	constexpr uint32_t m_vecPlayerPatchEconIndices = 0x1948;
	constexpr uint32_t m_GunGameImmunityColor = 0x195C;
	constexpr uint32_t m_grenadeParameterStashTime = 0x1960;
	constexpr uint32_t m_bGrenadeParametersStashed = 0x1964;
	constexpr uint32_t m_angStashedShootAngles = 0x1968;
	constexpr uint32_t m_vecStashedGrenadeThrowPosition = 0x1974;
	constexpr uint32_t m_vecStashedVelocity = 0x1980;
	constexpr uint32_t m_angShootAngleHistory = 0x198C;
	constexpr uint32_t m_vecThrowPositionHistory = 0x19A4;
	constexpr uint32_t m_vecVelocityHistory = 0x19BC;
}
...
{
	constexpr uint32_t m_CTouchExpansionComponent = 0xBB8;
	constexpr uint32_t m_pPingServices = 0xC08;
	constexpr uint32_t m_pViewModelServices = 0xC10;
	constexpr uint32_t m_blindUntilTime = 0xC18;
	constexpr uint32_t m_blindStartTime = 0xC1C;
	constexpr uint32_t m_iPlayerState = 0xC20;
	constexpr uint32_t m_bRespawning = 0xCD0;
	constexpr uint32_t m_fImmuneToGunGameDamageTime = 0xCD4;
	constexpr uint32_t m_bGunGameImmunity = 0xCD8;
	constexpr uint32_t m_fMolotovDamageTime = 0xCDC;
	constexpr uint32_t m_bHasMovedSinceSpawn = 0xCE0;
	constexpr uint32_t m_iNumSpawns = 0xCE4;
	constexpr uint32_t m_flIdleTimeSinceLastAction = 0xCEC;
	constexpr uint32_t m_fNextRadarUpdateTime = 0xCF0;
	constexpr uint32_t m_flFlashDuration = 0xCF4;
	constexpr uint32_t m_flFlashMaxAlpha = 0xCF8;
	constexpr uint32_t m_flProgressBarStartTime = 0xCFC;
	constexpr uint32_t m_iProgressBarDuration = 0xD00;
	constexpr uint32_t m_angEyeAngles = 0xD04;
	constexpr uint32_t m_bHud_MiniScoreHidden = 0xD10;
	constexpr uint32_t m_bHud_RadarHidden = 0xD11;
	constexpr uint32_t m_NumEnemiesAtRoundStart = 0xD14;
	constexpr uint32_t m_wasNotKilledNaturally = 0xD18;
	constexpr uint32_t m_hPet = 0xD1C;
	constexpr uint32_t m_bCommittingSuicideOnTeamChange = 0xD20;
	constexpr uint32_t m_hOriginalController = 0xD24;
}
