...
export const ServerDll = {
    ...
    CCSBot : {
        ...
        m_pathIndex : 0x4F10, // int32
        m_areaEnteredTimestamp : 0x4F14, // GameTime_t
        m_repathTimer : 0x4F18, // CountdownTimer
        m_avoidFriendTimer : 0x4F30, // CountdownTimer
        m_isFriendInTheWay : 0x4F48, // bool
        m_politeTimer : 0x4F50, // CountdownTimer
        m_isWaitingBehindFriend : 0x4F68, // bool
        m_pathLadderEnd : 0x4F94, // float32
        m_mustRunTimer : 0x4FE0, // CountdownTimer
        m_waitTimer : 0x4FF8, // CountdownTimer
        m_updateTravelDistanceTimer : 0x5010, // CountdownTimer
        m_playerTravelDistance : 0x5028, // float32[64]
        m_travelDistancePhase : 0x5128, // uint8
        m_hostageEscortCount : 0x52C0, // uint8
        m_hostageEscortCountTimestamp : 0x52C4, // float32
        m_desiredTeam : 0x52C8, // int32
        m_hasJoined : 0x52CC, // bool
        m_isWaitingForHostage : 0x52CD, // bool
        m_inhibitWaitingForHostageTimer : 0x52D0, // CountdownTimer
        m_waitForHostageTimer : 0x52E8, // CountdownTimer
        m_noisePosition : 0x5300, // Vector
        m_noiseTravelDistance : 0x530C, // float32
        m_noiseTimestamp : 0x5310, // float32
        m_noiseSource : 0x5318, // CCSPlayerPawn*
        m_noiseBendTimer : 0x5330, // CountdownTimer
        m_bentNoisePosition : 0x5348, // Vector
        m_bendNoisePositionValid : 0x5354, // bool
        m_lookAroundStateTimestamp : 0x5358, // float32
        m_lookAheadAngle : 0x535C, // float32
        m_lookUpAngle : 0x5360, // float32
        m_forwardAngle : 0x5364, // float32
        m_inhibitLookAroundTimestamp : 0x5368, // float32
        m_lookAtSpot : 0x5370, // Vector
        m_lookAtSpotDuration : 0x5380, // float32
        m_lookAtSpotTimestamp : 0x5384, // float32
        m_lookAtSpotAngleTolerance : 0x5388, // float32
        m_lookAtSpotClearIfClose : 0x538C, // bool
        m_lookAtSpotAttack : 0x538D, // bool
        m_lookAtDesc : 0x5390, // char*
        m_peripheralTimestamp : 0x5398, // float32
        m_approachPointCount : 0x5520, // uint8
        m_approachPointViewPosition : 0x5524, // Vector
        m_viewSteadyTimer : 0x5530, // IntervalTimer
        m_tossGrenadeTimer : 0x5548, // CountdownTimer
        m_isAvoidingGrenade : 0x5568, // CountdownTimer
        m_spotCheckTimestamp : 0x5588, // float32
        m_checkedHidingSpotCount : 0x5990, // int32
        m_lookPitch : 0x5994, // float32
        m_lookPitchVel : 0x5998, // float32
        m_lookYaw : 0x599C, // float32
        m_lookYawVel : 0x59A0, // float32
        m_targetSpot : 0x59A4, // Vector
        m_targetSpotVelocity : 0x59B0, // Vector
        m_targetSpotPredicted : 0x59BC, // Vector
        m_aimError : 0x59C8, // QAngle
        m_aimGoal : 0x59D4, // QAngle
        m_targetSpotTime : 0x59E0, // GameTime_t
        m_aimFocus : 0x59E4, // float32
        m_aimFocusInterval : 0x59E8, // float32
        m_aimFocusNextUpdate : 0x59EC, // GameTime_t
        m_ignoreEnemiesTimer : 0x59F8, // CountdownTimer
        m_enemy : 0x5A10, // CHandle<CCSPlayerPawn>
        m_isEnemyVisible : 0x5A14, // bool
        m_visibleEnemyParts : 0x5A15, // uint8
        m_lastEnemyPosition : 0x5A18, // Vector
        m_lastSawEnemyTimestamp : 0x5A24, // float32
        m_firstSawEnemyTimestamp : 0x5A28, // float32
        m_currentEnemyAcquireTimestamp : 0x5A2C, // float32
        m_enemyDeathTimestamp : 0x5A30, // float32
        m_friendDeathTimestamp : 0x5A34, // float32
        m_isLastEnemyDead : 0x5A38, // bool
        m_nearbyEnemyCount : 0x5A3C, // int32
        m_bomber : 0x5C48, // CHandle<CCSPlayerPawn>
        m_nearbyFriendCount : 0x5C4C, // int32
        m_closestVisibleFriend : 0x5C50, // CHandle<CCSPlayerPawn>
        m_closestVisibleHumanFriend : 0x5C54, // CHandle<CCSPlayerPawn>
        m_attentionInterval : 0x5C58, // IntervalTimer
        m_attacker : 0x5C68, // CHandle<CCSPlayerPawn>
        m_attackedTimestamp : 0x5C6C, // float32
        m_burnedByFlamesTimer : 0x5C70, // IntervalTimer
        m_lastVictimID : 0x5C80, // int32
        m_isAimingAtEnemy : 0x5C84, // bool
        m_isRapidFiring : 0x5C85, // bool
        m_equipTimer : 0x5C88, // IntervalTimer
        m_zoomTimer : 0x5C98, // CountdownTimer
        m_fireWeaponTimestamp : 0x5CB0, // GameTime_t
        m_lookForWeaponsOnGroundTimer : 0x5CB8, // CountdownTimer
        m_bIsSleeping : 0x5CD0, // bool
        m_isEnemySniperVisible : 0x5CD1, // bool
        m_sawEnemySniperTimer : 0x5CD8, // CountdownTimer
        m_enemyQueueIndex : 0x5D90, // uint8
        m_enemyQueueCount : 0x5D91, // uint8
        m_enemyQueueAttendIndex : 0x5D92, // uint8
        m_isStuck : 0x5D93, // bool
        m_stuckTimestamp : 0x5D94, // GameTime_t
        m_stuckSpot : 0x5D98, // Vector
        m_wiggleTimer : 0x5DA8, // CountdownTimer
        m_stuckJumpTimer : 0x5DC0, // CountdownTimer
        m_nextCleanupCheckTimestamp : 0x5DD8, // GameTime_t
        m_avgVel : 0x5DDC, // float32[10]
        m_avgVelIndex : 0x5E04, // int32
        m_avgVelCount : 0x5E08, // int32
        m_lastOrigin : 0x5E0C, // Vector
        m_lastRadioRecievedTimestamp : 0x5E1C, // float32
        m_lastRadioSentTimestamp : 0x5E20, // float32
        m_radioSubject : 0x5E24, // CHandle<CCSPlayerPawn>
        m_radioPosition : 0x5E28, // Vector
        m_voiceEndTimestamp : 0x5E34, // float32
        m_lastValidReactionQueueFrame : 0x5E40, // int32
    },
    CHandleTest : {
    ...
    CCSPlayerPawn : {
        ...
        m_bCommittingSuicideOnTeamChange : 0x1330, // bool
        m_wasNotKilledNaturally : 0x1331, // bool
        m_fImmuneToGunGameDamageTime : 0x1334, // GameTime_t
        m_bGunGameImmunity : 0x1338, // bool
        m_fMolotovDamageTime : 0x133C, // float32
        m_angEyeAngles : 0x1340, // QAngle
    },
    ...
    CCSPlayer_MovementServices : {
        ...
        m_nButtonDownMaskPrev : 0x690, // uint64
        m_bUseFrictionStashedSpeed : 0x698, // bool
        m_flUseFrictionStashedSpeedUntilFrac : 0x69C, // float32
        m_flFrictionStashedSpeed : 0x6A0, // float32
        m_flStamina : 0x6A4, // float32
        m_flHeightAtJumpStart : 0x6A8, // float32
        m_flMaxJumpHeightThisJump : 0x6AC, // float32
        m_flMaxJumpHeightLastJump : 0x6B0, // float32
        m_flStaminaAtJumpStart : 0x6B4, // float32
        m_flVelMulAtJumpStart : 0x6B8, // float32
        m_flAccumulatedJumpError : 0x6BC, // float32
        m_LegacyJump : 0x6C0, // CCSPlayerLegacyJump
        m_ModernJump : 0x6D8, // CCSPlayerModernJump
        m_nLastJumpTick : 0x710, // GameTick_t
        m_flLastJumpFrac : 0x714, // float32
        m_flLastJumpVelocityZ : 0x718, // float32
        m_bJumpApexPending : 0x71C, // bool
        m_flTicksSinceLastSurfingDetected : 0x720, // float32
        m_bWasSurfing : 0x724, // bool
        m_vecWalkWishVel : 0x7B4, // Vector2D
        m_bHasEverProcessedCommand : 0xFE0, // bool
    },
