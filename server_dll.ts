...
export const ServerDll = {
    ...
    CCSPlayerPawn : {
        ...
        m_vecStashedGrenadeThrowPawnCenter : 0x1340, // VectorWS
        m_vecStashedVelocity : 0x134C, // Vector
        m_bCommittingSuicideOnTeamChange : 0x1360, // bool
        m_wasNotKilledNaturally : 0x1361, // bool
        m_fImmuneToGunGameDamageTime : 0x1364, // GameTime_t
        m_bGunGameImmunity : 0x1368, // bool
        m_fMolotovDamageTime : 0x136C, // float32
        m_angEyeAngles : 0x1370, // QAngle
    },
    ...
    CCSCustomHudLayout : {
        m_strLayout : 0x4A8, // CUtlSymbolLarge
        m_bObservable : 0x4B0, // bool
        m_vecPlayerLayoutStates : 0x4B8, // CUtlVectorEmbeddedNetworkVar<CCSCustomHudLayoutState>
        m_globalLayoutState : 0x520, // CCSCustomHudLayoutState
        m_vecPanelIds : 0x6B8, // CNetworkUtlVectorBase<CUtlString>
        m_vecClassNames : 0x6D0, // CNetworkUtlVectorBase<CUtlString>
        m_vecDialogVariableNames : 0x6E8, // CNetworkUtlVectorBase<CUtlString>
    },
    CEntityInstance : {
