...
namespace CBaseRendererSource2
{
	...
	constexpr uint32_t m_flDiffuseClamp = 0x1208;
	constexpr uint32_t m_nLightingControlPoint = 0x1360;
	constexpr uint32_t m_nSelfIllumPerParticle = 0x1364;
	constexpr uint32_t m_nOutputBlendMode = 0x1368;
	constexpr uint32_t m_bGammaCorrectVertexColors = 0x136C;
	constexpr uint32_t m_bSaturateColorPreAlphaBlend = 0x136D;
	constexpr uint32_t m_flAddSelfAmount = 0x1370;
	constexpr uint32_t m_flDesaturation = 0x14C8;
	constexpr uint32_t m_flOverbrightFactor = 0x1620;
	constexpr uint32_t m_nHSVShiftControlPoint = 0x1778;
	constexpr uint32_t m_nFogType = 0x177C;
	constexpr uint32_t m_flFogAmount = 0x1780;
	constexpr uint32_t m_bTintByFOW = 0x18D8;
	constexpr uint32_t m_bTintByGlobalLight = 0x18D9;
	constexpr uint32_t m_nPerParticleAlphaReference = 0x18DC;
	constexpr uint32_t m_nPerParticleAlphaRefWindow = 0x18E0;
	constexpr uint32_t m_nAlphaReferenceType = 0x18E4;
	constexpr uint32_t m_flAlphaReferenceSoftness = 0x18E8;
	constexpr uint32_t m_flSourceAlphaValueToMapToZero = 0x1A40;
	constexpr uint32_t m_flSourceAlphaValueToMapToOne = 0x1B98;
	constexpr uint32_t m_bRefract = 0x1CF0;
	constexpr uint32_t m_bRefractSolid = 0x1CF1;
	constexpr uint32_t m_flRefractAmount = 0x1CF8;
	constexpr uint32_t m_nRefractBlurRadius = 0x1E50;
	constexpr uint32_t m_nRefractBlurType = 0x1E54;
	constexpr uint32_t m_bOnlyRenderInEffectsBloomPass = 0x1E58;
	constexpr uint32_t m_bOnlyRenderInEffectsWaterPass = 0x1E59;
	constexpr uint32_t m_bUseMixedResolutionRendering = 0x1E5A;
	constexpr uint32_t m_bOnlyRenderInEffecsGameOverlay = 0x1E5B;
	constexpr uint32_t m_stencilTestID = 0x1E5C;
	constexpr uint32_t m_bStencilTestExclude = 0x1EDC;
	constexpr uint32_t m_stencilWriteID = 0x1EDD;
	constexpr uint32_t m_bWriteStencilOnDepthPass = 0x1F5D;
	constexpr uint32_t m_bWriteStencilOnDepthFail = 0x1F5E;
	constexpr uint32_t m_bReverseZBuffering = 0x1F5F;
	constexpr uint32_t m_bDisableZBuffering = 0x1F60;
	constexpr uint32_t m_nFeatheringMode = 0x1F64;
	constexpr uint32_t m_flFeatheringMinDist = 0x1F68;
	constexpr uint32_t m_flFeatheringMaxDist = 0x20C0;
	constexpr uint32_t m_flFeatheringFilter = 0x2218;
	constexpr uint32_t m_flDepthBias = 0x2370;
	constexpr uint32_t m_nSortMethod = 0x24C8;
	constexpr uint32_t m_bBlendFramesSeq0 = 0x24CC;
	constexpr uint32_t m_bMaxLuminanceBlendingSequence0 = 0x24CD;
}
...
{
	constexpr uint32_t m_nSequenceOverride = 0x2710;
	constexpr uint32_t m_nOrientationType = 0x2868;
	constexpr uint32_t m_nOrientationControlPoint = 0x286C;
	constexpr uint32_t m_bUseYawWithNormalAligned = 0x2870;
	constexpr uint32_t m_flMinSize = 0x2878;
	constexpr uint32_t m_flMaxSize = 0x29D0;
	constexpr uint32_t m_flAlphaAdjustWithSizeAdjust = 0x2B28;
	constexpr uint32_t m_flStartFadeSize = 0x2C80;
	constexpr uint32_t m_flEndFadeSize = 0x2DD8;
	constexpr uint32_t m_flStartFadeDot = 0x2F30;
	constexpr uint32_t m_flEndFadeDot = 0x2F34;
	constexpr uint32_t m_bDistanceAlpha = 0x2F38;
	constexpr uint32_t m_bSoftEdges = 0x2F39;
	constexpr uint32_t m_flEdgeSoftnessStart = 0x2F3C;
	constexpr uint32_t m_flEdgeSoftnessEnd = 0x2F40;
	constexpr uint32_t m_bOutline = 0x2F44;
	constexpr uint32_t m_OutlineColor = 0x2F45;
	constexpr uint32_t m_nOutlineAlpha = 0x2F4C;
	constexpr uint32_t m_flOutlineStart0 = 0x2F50;
	constexpr uint32_t m_flOutlineStart1 = 0x2F54;
	constexpr uint32_t m_flOutlineEnd0 = 0x2F58;
	constexpr uint32_t m_flOutlineEnd1 = 0x2F5C;
	constexpr uint32_t m_nLightingMode = 0x2F60;
	constexpr uint32_t m_flLightingTessellation = 0x2F68;
	constexpr uint32_t m_flLightingDirectionality = 0x30C0;
	constexpr uint32_t m_bParticleShadows = 0x3218;
	constexpr uint32_t m_flShadowDensity = 0x321C;
}
...
namespace C_OP_PlanarConstraint
{
	...
	constexpr uint32_t m_bUseOldCode = 0x490;
}
...
namespace C_INIT_CreateOnModel
{
	...
	constexpr uint32_t m_bUseMesh = 0xFD2;
...
{
	constexpr uint32_t m_ColorFadeMin = 0x1C0;
	constexpr uint32_t m_ColorFadeMax = 0x1DC;
	constexpr uint32_t m_flFadeStartTime = 0x1EC;
	constexpr uint32_t m_flFadeEndTime = 0x1F0;
	constexpr uint32_t m_nFieldOutput = 0x1F4;
	constexpr uint32_t m_bEaseInOut = 0x1F8;
}
...
namespace C_OP_PositionLock
{
	...
	constexpr uint32_t m_flStartTime_exp = 0x230;
	constexpr uint32_t m_flEndTime_min = 0x234;
	constexpr uint32_t m_flEndTime_max = 0x238;
	constexpr uint32_t m_flEndTime_exp = 0x23C;
	constexpr uint32_t m_flRange = 0x240;
	constexpr uint32_t m_flRangeBias = 0x248;
	constexpr uint32_t m_flJumpThreshold = 0x3A0;
	constexpr uint32_t m_flPrevPosScale = 0x3A4;
	constexpr uint32_t m_bLockRot = 0x3A8;
	constexpr uint32_t m_vecScale = 0x3B0;
	constexpr uint32_t m_nFieldOutput = 0xA08;
	constexpr uint32_t m_nFieldOutputPrev = 0xA0C;
}

namespace C_OP_ControlpointLight
{
	constexpr uint32_t m_flScale = 0x1C0;
	constexpr uint32_t m_nControlPoint1 = 0x650;
	constexpr uint32_t m_nControlPoint2 = 0x654;
	constexpr uint32_t m_nControlPoint3 = 0x658;
	constexpr uint32_t m_nControlPoint4 = 0x65C;
	constexpr uint32_t m_vecCPOffset1 = 0x660;
	constexpr uint32_t m_vecCPOffset2 = 0x66C;
	constexpr uint32_t m_vecCPOffset3 = 0x678;
	constexpr uint32_t m_vecCPOffset4 = 0x684;
	constexpr uint32_t m_LightFiftyDist1 = 0x690;
	constexpr uint32_t m_LightZeroDist1 = 0x694;
	constexpr uint32_t m_LightFiftyDist2 = 0x698;
	constexpr uint32_t m_LightZeroDist2 = 0x69C;
	constexpr uint32_t m_LightFiftyDist3 = 0x6A0;
	constexpr uint32_t m_LightZeroDist3 = 0x6A4;
	constexpr uint32_t m_LightFiftyDist4 = 0x6A8;
	constexpr uint32_t m_LightZeroDist4 = 0x6AC;
	constexpr uint32_t m_LightColor1 = 0x6B0;
	constexpr uint32_t m_LightColor2 = 0x6B4;
	constexpr uint32_t m_LightColor3 = 0x6B8;
	constexpr uint32_t m_LightColor4 = 0x6BC;
	constexpr uint32_t m_bLightType1 = 0x6C0;
	constexpr uint32_t m_bLightType2 = 0x6C1;
	constexpr uint32_t m_bLightType3 = 0x6C2;
	constexpr uint32_t m_bLightType4 = 0x6C3;
	constexpr uint32_t m_bLightDynamic1 = 0x6C4;
	constexpr uint32_t m_bLightDynamic2 = 0x6C5;
	constexpr uint32_t m_bLightDynamic3 = 0x6C6;
	constexpr uint32_t m_bLightDynamic4 = 0x6C7;
	constexpr uint32_t m_bUseNormal = 0x6C8;
	constexpr uint32_t m_bUseHLambert = 0x6C9;
	constexpr uint32_t m_bClampLowerRange = 0x6CE;
	constexpr uint32_t m_bClampUpperRange = 0x6CF;
}

namespace C_OP_GlobalLight
{
	constexpr uint32_t m_flScale = 0x1C0;
	constexpr uint32_t m_bClampLowerRange = 0x1C4;
	constexpr uint32_t m_bClampUpperRange = 0x1C5;
}

namespace C_OP_SetChildControlPoints
{
	constexpr uint32_t m_nChildGroupID = 0x1C0;
	constexpr uint32_t m_nFirstControlPoint = 0x1C4;
	constexpr uint32_t m_nNumControlPoints = 0x1C8;
	constexpr uint32_t m_nFirstSourcePoint = 0x1D0;
	constexpr uint32_t m_bReverse = 0x328;
	constexpr uint32_t m_bSetOrientation = 0x329;
}
...
namespace C_OP_SetControlPointsToParticle
{
	...
	constexpr uint32_t m_nOrientationMode = 0x1D4;
	constexpr uint32_t m_nSetParent = 0x1D8;
}

namespace C_OP_SetControlPointsToModelParticles
{
	constexpr uint32_t m_HitboxSetName = 0x1C0;
	constexpr uint32_t m_AttachmentName = 0x240;
	constexpr uint32_t m_nFirstControlPoint = 0x2C0;
	constexpr uint32_t m_nNumControlPoints = 0x2C4;
	constexpr uint32_t m_nFirstSourcePoint = 0x2C8;
	constexpr uint32_t m_bSkin = 0x2CC;
	constexpr uint32_t m_bAttachment = 0x2CD;
}
...
namespace C_OP_SetPerChildControlPoint
{
	...
	constexpr uint32_t m_nFirstControlPoint = 0x1C4;
	constexpr uint32_t m_nNumControlPoints = 0x1C8;
	constexpr uint32_t m_nParticleIncrement = 0x1D0;
	constexpr uint32_t m_nFirstSourcePoint = 0x328;
	constexpr uint32_t m_bSetOrientation = 0x480;
	constexpr uint32_t m_nOrientationField = 0x484;
	constexpr uint32_t m_bNumBasedOnParticleCount = 0x488;
}
...
namespace C_OP_SetPerChildControlPointFromAttribute
{
	...
	constexpr uint32_t m_nFirstControlPoint = 0x1C4;
	constexpr uint32_t m_nNumControlPoints = 0x1C8;
	constexpr uint32_t m_nParticleIncrement = 0x1CC;
	constexpr uint32_t m_nFirstSourcePoint = 0x1D0;
	constexpr uint32_t m_bNumBasedOnParticleCount = 0x1D4;
	constexpr uint32_t m_nAttributeToRead = 0x1D8;
	constexpr uint32_t m_nCPField = 0x1DC;
}
...
namespace C_OP_RemapTransformOrientationToYaw
{
	constexpr uint32_t m_TransformInput = 0x1C0;
	constexpr uint32_t m_nFieldOutput = 0x228;
	constexpr uint32_t m_flRotOffset = 0x22C;
	constexpr uint32_t m_flSpinStrength = 0x230;
}

namespace C_OP_DampenToCP
{
	constexpr uint32_t m_nControlPointNumber = 0x1C0;
	constexpr uint32_t m_flRange = 0x1C4;
...
{
	constexpr uint32_t m_nControlPointNumber = 0x1C0;
	constexpr uint32_t m_vecOffset = 0x1C4;
	constexpr uint32_t m_bOffsetLocal = 0x1D0;
}
...
namespace C_OP_PinParticleToCP
{
	constexpr uint32_t m_nControlPointNumber = 0x1C0;
	constexpr uint32_t m_vecOffset = 0x1C8;
	constexpr uint32_t m_bOffsetLocal = 0x820;
	constexpr uint32_t m_nParticleSelection = 0x824;
	constexpr uint32_t m_nParticleNumber = 0x828;
	constexpr uint32_t m_nPinBreakType = 0x980;
	constexpr uint32_t m_flBreakDistance = 0x988;
	constexpr uint32_t m_flBreakSpeed = 0xAE0;
	constexpr uint32_t m_flAge = 0xC38;
	constexpr uint32_t m_nBreakControlPointNumber = 0xD90;
	constexpr uint32_t m_nBreakControlPointNumber2 = 0xD94;
	constexpr uint32_t m_flBreakValue = 0xD98;
	constexpr uint32_t m_flInterpolation = 0xEF0;
}

namespace C_OP_MovementRigidAttachToCP
{
	constexpr uint32_t m_nControlPointNumber = 0x1C0;
	constexpr uint32_t m_nScaleControlPoint = 0x1C4;
	constexpr uint32_t m_nScaleCPField = 0x1C8;
	constexpr uint32_t m_nFieldInput = 0x1CC;
	constexpr uint32_t m_nFieldOutput = 0x1D0;
	constexpr uint32_t m_bOffsetLocal = 0x1D4;
}
...
namespace C_OP_LerpToInitialPosition
{
	constexpr uint32_t m_nControlPointNumber = 0x1C0;
	constexpr uint32_t m_flInterpolation = 0x1C8;
	constexpr uint32_t m_nCacheField = 0x320;
	constexpr uint32_t m_flScale = 0x328;
	constexpr uint32_t m_vecScale = 0x480;
}
...
namespace C_OP_DistanceBetweenTransforms
{
	...
	constexpr uint32_t m_flInputMin = 0x298;
	constexpr uint32_t m_flInputMax = 0x3F0;
	constexpr uint32_t m_flOutputMin = 0x548;
	constexpr uint32_t m_flOutputMax = 0x6A0;
	constexpr uint32_t m_flMaxTraceLength = 0x7F8;
	constexpr uint32_t m_flLOSScale = 0x7FC;
	constexpr uint32_t m_CollisionGroupName = 0x800;
	constexpr uint32_t m_nTraceSet = 0x880;
	constexpr uint32_t m_bLOS = 0x884;
	constexpr uint32_t m_nSetMethod = 0x888;
}
...
namespace C_OP_PercentageBetweenTransforms
{
	...
	constexpr uint32_t m_flOutputMin = 0x1CC;
	constexpr uint32_t m_flOutputMax = 0x1D0;
	constexpr uint32_t m_TransformStart = 0x1D8;
	constexpr uint32_t m_TransformEnd = 0x240;
...
namespace C_OP_PercentageBetweenTransformsVector
{
	...
	constexpr uint32_t m_flInputMin = 0x1C4;
	constexpr uint32_t m_flInputMax = 0x1C8;
	constexpr uint32_t m_vecOutputMin = 0x1CC;
	constexpr uint32_t m_vecOutputMax = 0x1D8;
	constexpr uint32_t m_TransformStart = 0x1E8;
	constexpr uint32_t m_TransformEnd = 0x250;
	constexpr uint32_t m_nSetMethod = 0x2B8;
	constexpr uint32_t m_bActiveRange = 0x2BC;
	constexpr uint32_t m_bRadialCheck = 0x2BD;
}
...
namespace C_OP_PercentageBetweenTransformLerpCPs
{
	...
	constexpr uint32_t m_nOutputStartCP = 0x2A0;
	constexpr uint32_t m_nOutputStartField = 0x2A4;
	constexpr uint32_t m_nOutputEndCP = 0x2A8;
	constexpr uint32_t m_nOutputEndField = 0x2AC;
...
{
	constexpr uint32_t m_nFieldOutput = 0x1C0;
	constexpr uint32_t m_vecPoint1 = 0x1C8;
	constexpr uint32_t m_vecPoint2 = 0x820;
	constexpr uint32_t m_flInputMin = 0xE78;
	constexpr uint32_t m_flInputMax = 0xFD0;
	constexpr uint32_t m_flOutputMin = 0x1128;
	constexpr uint32_t m_flOutputMax = 0x1280;
	constexpr uint32_t m_nSetMethod = 0x13D8;
	constexpr uint32_t m_bDeltaTime = 0x13DC;
}
...
namespace C_OP_DistanceToTransform
{
	...
	constexpr uint32_t m_flOutputMin = 0x478;
	constexpr uint32_t m_flOutputMax = 0x5D0;
	constexpr uint32_t m_TransformStart = 0x728;
	constexpr uint32_t m_bLOS = 0x790;
	constexpr uint32_t m_CollisionGroupName = 0x791;
	constexpr uint32_t m_nTraceSet = 0x814;
	constexpr uint32_t m_flMaxTraceLength = 0x818;
	constexpr uint32_t m_flLOSScale = 0x81C;
	constexpr uint32_t m_nSetMethod = 0x820;
	constexpr uint32_t m_bActiveRange = 0x824;
	constexpr uint32_t m_bAdditive = 0x825;
	constexpr uint32_t m_vecComponentScale = 0x828;
}
...
namespace C_OP_CylindricalDistanceToTransform
{
	...
	constexpr uint32_t m_flOutputMax = 0x5D0;
	constexpr uint32_t m_TransformStart = 0x728;
	constexpr uint32_t m_TransformEnd = 0x790;
	constexpr uint32_t m_nSetMethod = 0x7F8;
	constexpr uint32_t m_bActiveRange = 0x7FC;
	constexpr uint32_t m_bAdditive = 0x7FD;
	constexpr uint32_t m_bCapsule = 0x7FE;
}
...
namespace C_OP_RtEnvCull
{
	constexpr uint32_t m_vecTestDir = 0x1C0;
	constexpr uint32_t m_vecTestNormal = 0x1CC;
	constexpr uint32_t m_bCullOnMiss = 0x1D8;
	constexpr uint32_t m_bStickInsteadOfCull = 0x1D9;
	constexpr uint32_t m_RtEnvName = 0x1DA;
	constexpr uint32_t m_nRTEnvCP = 0x25C;
	constexpr uint32_t m_nComponent = 0x260;
}
...
namespace C_OP_MovementLoopInsideSphere
{
	...
	constexpr uint32_t m_nDistSqrAttr = 0x978;
}
...
namespace C_OP_MoveToHitbox
{
	constexpr uint32_t m_modelInput = 0x1C0;
	constexpr uint32_t m_transformInput = 0x220;
	constexpr uint32_t m_flLifeTimeLerpStart = 0x28C;
	constexpr uint32_t m_flLifeTimeLerpEnd = 0x290;
	constexpr uint32_t m_flPrevPosScale = 0x294;
	constexpr uint32_t m_HitboxSetName = 0x298;
	constexpr uint32_t m_bUseBones = 0x318;
	constexpr uint32_t m_nLerpType = 0x31C;
...
namespace C_OP_LockToBone
{
	constexpr uint32_t m_modelInput = 0x1C0;
	constexpr uint32_t m_transformInput = 0x220;
	constexpr uint32_t m_flLifeTimeFadeStart = 0x288;
	constexpr uint32_t m_flLifeTimeFadeEnd = 0x28C;
	constexpr uint32_t m_flJumpThreshold = 0x290;
	constexpr uint32_t m_flPrevPosScale = 0x294;
	constexpr uint32_t m_HitboxSetName = 0x298;
	constexpr uint32_t m_bRigid = 0x318;
	constexpr uint32_t m_bUseBones = 0x319;
	constexpr uint32_t m_nFieldOutput = 0x31C;
	constexpr uint32_t m_nFieldOutputPrev = 0x320;
	constexpr uint32_t m_nRotationSetType = 0x324;
	constexpr uint32_t m_bRigidRotationLock = 0x328;
	constexpr uint32_t m_vecRotation = 0x330;
	constexpr uint32_t m_flRotLerp = 0x988;
}

namespace C_OP_SnapshotRigidSkinToBones
{
	constexpr uint32_t m_bTransformNormals = 0x1C0;
	constexpr uint32_t m_bTransformRadii = 0x1C1;
	constexpr uint32_t m_nControlPointNumber = 0x1C4;
}
...
namespace C_OP_SnapshotSkinToBones
{
	...
	constexpr uint32_t m_bTransformRadii = 0x1C1;
	constexpr uint32_t m_nControlPointNumber = 0x1C4;
	constexpr uint32_t m_flLifeTimeFadeStart = 0x1C8;
	constexpr uint32_t m_flLifeTimeFadeEnd = 0x1CC;
	constexpr uint32_t m_flJumpThreshold = 0x1D0;
	constexpr uint32_t m_flPrevPosScale = 0x1D4;
}
...
namespace C_OP_CPOffsetToPercentageBetweenCPs
{
	...
	constexpr uint32_t m_flInputBias = 0x1C8;
	constexpr uint32_t m_nStartCP = 0x1CC;
	constexpr uint32_t m_nEndCP = 0x1D0;
	constexpr uint32_t m_nOffsetCP = 0x1D4;
	constexpr uint32_t m_nOuputCP = 0x1D8;
	constexpr uint32_t m_nInputCP = 0x1DC;
	constexpr uint32_t m_bRadialCheck = 0x1E0;
	constexpr uint32_t m_bScaleOffset = 0x1E1;
	constexpr uint32_t m_vecOffset = 0x1E4;
}

namespace C_OP_PlaneCull
{
	constexpr uint32_t m_nPlaneControlPoint = 0x1C0;
	constexpr uint32_t m_vecPlaneDirection = 0x1C4;
	constexpr uint32_t m_bLocalSpace = 0x1D0;
	constexpr uint32_t m_flPlaneOffset = 0x1D4;
}

namespace C_OP_DistanceCull
{
	constexpr uint32_t m_nControlPoint = 0x1C0;
	constexpr uint32_t m_vecPointOffset = 0x1C4;
	constexpr uint32_t m_flDistance = 0x1D0;
	constexpr uint32_t m_bCullInside = 0x1D4;
}
...
namespace C_OP_ModelDampenMovement
{
	constexpr uint32_t m_nControlPointNumber = 0x1C0;
	constexpr uint32_t m_bBoundBox = 0x1C4;
	constexpr uint32_t m_bOutside = 0x1C5;
	constexpr uint32_t m_bUseBones = 0x1C6;
	constexpr uint32_t m_HitboxSetName = 0x1C7;
	constexpr uint32_t m_vecPosOffset = 0x248;
	constexpr uint32_t m_fDrag = 0x8A0;
}
...
{
	constexpr uint32_t m_flDirScale = 0x1C0;
	constexpr uint32_t m_flSpdScale = 0x1C4;
	constexpr uint32_t m_nCPBroadcast = 0x1C8;
}

namespace C_OP_MovementMaintainOffset
{
	constexpr uint32_t m_vecOffset = 0x1C0;
	constexpr uint32_t m_nCP = 0x1CC;
	constexpr uint32_t m_bRadiusScale = 0x1D0;
}
...
namespace C_OP_MovementPlaceOnGround
{
	constexpr uint32_t m_flOffset = 0x1C0;
	constexpr uint32_t m_flMaxTraceLength = 0x318;
	constexpr uint32_t m_flTolerance = 0x31C;
	constexpr uint32_t m_flTraceOffset = 0x320;
	constexpr uint32_t m_flLerpRate = 0x324;
	constexpr uint32_t m_CollisionGroupName = 0x328;
	constexpr uint32_t m_nTraceSet = 0x3A8;
	constexpr uint32_t m_nRefCP1 = 0x3AC;
	constexpr uint32_t m_nRefCP2 = 0x3B0;
	constexpr uint32_t m_nLerpCP = 0x3B4;
	constexpr uint32_t m_nTraceMissBehavior = 0x3C0;
	constexpr uint32_t m_bIncludeShotHull = 0x3C4;
	constexpr uint32_t m_bIncludeWater = 0x3C5;
	constexpr uint32_t m_bSetNormal = 0x3C8;
	constexpr uint32_t m_bScaleOffset = 0x3C9;
	constexpr uint32_t m_nPreserveOffsetCP = 0x3CC;
	constexpr uint32_t m_nIgnoreCP = 0x3D0;
}
...
namespace C_OP_InheritFromParentParticlesV2
{
	...
	constexpr uint32_t m_nIncrement = 0x1C8;
	constexpr uint32_t m_bRandomDistribution = 0x1CC;
	constexpr uint32_t m_nMissingParentBehavior = 0x1D0;
}
...
namespace C_OP_ReadFromNeighboringParticle
{
	...
	constexpr uint32_t m_nFieldOutput = 0x1C4;
	constexpr uint32_t m_nIncrement = 0x1C8;
	constexpr uint32_t m_DistanceCheck = 0x1D0;
	constexpr uint32_t m_flInterpolation = 0x328;
}
...
namespace C_OP_InheritFromPeerSystem
{
	...
	constexpr uint32_t m_nFieldInput = 0x1C4;
	constexpr uint32_t m_nIncrement = 0x1C8;
	constexpr uint32_t m_nGroupID = 0x1CC;
}
...
{
	constexpr uint32_t m_flRotOffset = 0x1C0;
	constexpr uint32_t m_flSpinStrength = 0x1C4;
	constexpr uint32_t m_nFieldOutput = 0x1C8;
}

namespace C_OP_RestartAfterDuration
{
	constexpr uint32_t m_flDurationMin = 0x1C0;
	constexpr uint32_t m_flDurationMax = 0x1C4;
	constexpr uint32_t m_nCP = 0x1C8;
	constexpr uint32_t m_nCPField = 0x1CC;
	constexpr uint32_t m_nChildGroupID = 0x1D0;
	constexpr uint32_t m_bOnlyChildren = 0x1D4;
}
...
namespace C_OP_MovementRotateParticleAroundAxis
{
	...
	constexpr uint32_t m_TransformInput = 0x970;
	constexpr uint32_t m_bLocalSpace = 0x9D8;
}

namespace C_OP_RotateVector
{
	constexpr uint32_t m_nFieldOutput = 0x1C0;
	constexpr uint32_t m_vecRotAxisMin = 0x1C4;
	constexpr uint32_t m_vecRotAxisMax = 0x1D0;
	constexpr uint32_t m_flRotRateMin = 0x1DC;
	constexpr uint32_t m_flRotRateMax = 0x1E0;
	constexpr uint32_t m_bNormalize = 0x1E4;
	constexpr uint32_t m_flScale = 0x1E8;
}

namespace C_OP_MaxVelocity
{
	constexpr uint32_t m_flMaxVelocity = 0x1C0;
	constexpr uint32_t m_flMinVelocity = 0x1C4;
	constexpr uint32_t m_nOverrideCP = 0x1C8;
	constexpr uint32_t m_nOverrideCPField = 0x1CC;
}

namespace C_OP_LagCompensation
{
	constexpr uint32_t m_nDesiredVelocityCP = 0x1C0;
	constexpr uint32_t m_nLatencyCP = 0x1C4;
	constexpr uint32_t m_nLatencyCPField = 0x1C8;
	constexpr uint32_t m_nDesiredVelocityCPField = 0x1CC;
}
...
namespace C_OP_MaintainSequentialPath
{
	constexpr uint32_t m_fMaxDistance = 0x1C0;
	constexpr uint32_t m_flNumToAssign = 0x1C4;
	constexpr uint32_t m_flCohesionStrength = 0x1C8;
	constexpr uint32_t m_flTolerance = 0x1CC;
	constexpr uint32_t m_bLoop = 0x1D0;
	constexpr uint32_t m_bUseParticleCount = 0x1D1;
	constexpr uint32_t m_PathParams = 0x1E0;
}

namespace C_OP_LockToSavedSequentialPathV2
{
	constexpr uint32_t m_flFadeStart = 0x1C0;
	constexpr uint32_t m_flFadeEnd = 0x1C4;
	constexpr uint32_t m_bCPPairs = 0x1C8;
	constexpr uint32_t m_PathParams = 0x1D0;
}

namespace C_OP_LockToSavedSequentialPath
{
	constexpr uint32_t m_flFadeStart = 0x1C4;
	constexpr uint32_t m_flFadeEnd = 0x1C8;
	constexpr uint32_t m_bCPPairs = 0x1CC;
	constexpr uint32_t m_PathParams = 0x1D0;
}
...
namespace C_OP_RemapDotProductToScalar
{
	...
	constexpr uint32_t m_flOutputMin = 0x1D4;
	constexpr uint32_t m_flOutputMax = 0x1D8;
	constexpr uint32_t m_bUseParticleVelocity = 0x1DC;
	constexpr uint32_t m_nSetMethod = 0x1E0;
	constexpr uint32_t m_bActiveRange = 0x1E4;
	constexpr uint32_t m_bUseParticleNormal = 0x1E5;
}
...
namespace C_OP_RemapCPtoScalar
{
	...
	constexpr uint32_t m_nSetMethod = 0x1E8;
}
...
namespace C_OP_RemapCPtoVector
{
	constexpr uint32_t m_nCPInput = 0x1C0;
	constexpr uint32_t m_nFieldOutput = 0x1C4;
	constexpr uint32_t m_nLocalSpaceCP = 0x1C8;
	constexpr uint32_t m_vInputMin = 0x1CC;
	constexpr uint32_t m_vInputMax = 0x1D8;
	constexpr uint32_t m_vOutputMin = 0x1E4;
	constexpr uint32_t m_vOutputMax = 0x1F0;
	constexpr uint32_t m_flStartTime = 0x1FC;
	constexpr uint32_t m_flEndTime = 0x200;
	constexpr uint32_t m_flInterpRate = 0x204;
	constexpr uint32_t m_nSetMethod = 0x208;
	constexpr uint32_t m_bOffset = 0x20C;
	constexpr uint32_t m_bAccelerate = 0x20D;
}
...
{
	constexpr uint32_t m_nFieldOutput = 0x1C0;
	constexpr uint32_t m_flScale = 0x1C4;
...
namespace C_OP_RemapCPVelocityToVector
{
	...
	constexpr uint32_t m_nFieldOutput = 0x1C4;
	constexpr uint32_t m_flScale = 0x1C8;
	constexpr uint32_t m_bNormalize = 0x1CC;
}
...
namespace C_OP_RemapDirectionToCPToVector
{
	...
	constexpr uint32_t m_nFieldOutput = 0x1C4;
	constexpr uint32_t m_flScale = 0x1C8;
	constexpr uint32_t m_flOffsetRot = 0x1CC;
	constexpr uint32_t m_vecOffsetAxis = 0x1D0;
	constexpr uint32_t m_bNormalize = 0x1DC;
	constexpr uint32_t m_nFieldStrength = 0x1E0;
}

namespace C_OP_RemapCrossProductOfTwoVectorsToVector
{
	constexpr uint32_t m_InputVec1 = 0x1C0;
	constexpr uint32_t m_InputVec2 = 0x818;
	constexpr uint32_t m_nFieldOutput = 0xE70;
	constexpr uint32_t m_bNormalize = 0xE74;
}
...
{
	constexpr uint32_t m_flInterpRate = 0x1C0;
	constexpr uint32_t m_flMaxTraceLength = 0x1C4;
	constexpr uint32_t m_flTolerance = 0x1C8;
	constexpr uint32_t m_flTraceOffset = 0x1CC;
	constexpr uint32_t m_CollisionGroupName = 0x1D0;
	constexpr uint32_t m_nTraceSet = 0x250;
	constexpr uint32_t m_nInputCP = 0x254;
	constexpr uint32_t m_nOutputCP = 0x258;
	constexpr uint32_t m_bIncludeWater = 0x268;
}
...
namespace C_OP_RemapControlPointOrientationToRotation
{
	constexpr uint32_t m_nCP = 0x1C0;
	constexpr uint32_t m_nFieldOutput = 0x1C4;
	constexpr uint32_t m_flOffsetRot = 0x1C8;
	constexpr uint32_t m_nComponent = 0x1CC;
}
...
{
	constexpr uint32_t m_hModel = 0x1C0;
	constexpr uint32_t m_inNames = 0x1C8;
	constexpr uint32_t m_outNames = 0x1E0;
	constexpr uint32_t m_fallbackNames = 0x1F8;
	constexpr uint32_t m_bModelFromRenderer = 0x210;
	constexpr uint32_t m_bProportional = 0x211;
	constexpr uint32_t m_nFieldInput = 0x214;
	constexpr uint32_t m_nFieldOutput = 0x218;
	constexpr uint32_t m_flRemapTime = 0x21C;
}
...
namespace C_OP_SetFromCPSnapshot
{
	...
	constexpr uint32_t m_bRandom = 0x1D0;
	constexpr uint32_t m_bReverse = 0x1D1;
	constexpr uint32_t m_nRandomSeed = 0x1D4;
	constexpr uint32_t m_nSnapShotStartPoint = 0x1D8;
	constexpr uint32_t m_nSnapShotIncrement = 0x330;
	constexpr uint32_t m_flInterpolation = 0x488;
	constexpr uint32_t m_bSubSample = 0x5E0;
	constexpr uint32_t m_bPrev = 0x5E1;
}

namespace C_OP_VectorFieldSnapshot
{
	constexpr uint32_t m_nControlPointNumber = 0x1C0;
	constexpr uint32_t m_nAttributeToWrite = 0x1C4;
	constexpr uint32_t m_nLocalSpaceCP = 0x1C8;
	constexpr uint32_t m_flInterpolation = 0x1D0;
	constexpr uint32_t m_vecScale = 0x328;
	constexpr uint32_t m_flBoundaryDampening = 0x980;
	constexpr uint32_t m_bSetVelocity = 0x984;
	constexpr uint32_t m_bLockToSurface = 0x985;
	constexpr uint32_t m_flGridSpacing = 0x988;
}
...
namespace C_OP_SetFloatAttributeToVectorExpression
{
	...
	constexpr uint32_t m_nOutputField = 0xFD0;
	constexpr uint32_t m_nSetMethod = 0xFD4;
}
...
namespace C_OP_MovementSkinnedPositionFromCPSnapshot
{
	...
	constexpr uint32_t m_bRandom = 0x1C8;
	constexpr uint32_t m_nRandomSeed = 0x1CC;
	constexpr uint32_t m_bSetNormal = 0x1D0;
	constexpr uint32_t m_bSetRadius = 0x1D1;
	constexpr uint32_t m_nIndexType = 0x1D4;
	constexpr uint32_t m_flReadIndex = 0x1D8;
	constexpr uint32_t m_flIncrement = 0x330;
	constexpr uint32_t m_nFullLoopIncrement = 0x488;
	constexpr uint32_t m_nSnapShotStartPoint = 0x5E0;
	constexpr uint32_t m_flInterpolation = 0x738;
}

namespace C_OP_MovementMoveAlongSkinnedCPSnapshot
{
	constexpr uint32_t m_nControlPointNumber = 0x1C0;
	constexpr uint32_t m_nSnapshotControlPointNumber = 0x1C4;
	constexpr uint32_t m_bSetNormal = 0x1C8;
	constexpr uint32_t m_bSetRadius = 0x1C9;
	constexpr uint32_t m_flInterpolation = 0x1D0;
	constexpr uint32_t m_flTValue = 0x328;
}
...
namespace C_OP_SetFloatCollection
{
	...
	constexpr uint32_t m_nOutputField = 0x318;
	constexpr uint32_t m_nSetMethod = 0x31C;
	constexpr uint32_t m_Lerp = 0x320;
}
...
namespace C_OP_SetFloat
{
	...
	constexpr uint32_t m_nSetMethod = 0x31C;
	constexpr uint32_t m_Lerp = 0x320;
	constexpr uint32_t m_bUseNewCode = 0x478;
}
...
namespace C_OP_SetVec
{
	...
	constexpr uint32_t m_nOutputField = 0x818;
	constexpr uint32_t m_nSetMethod = 0x81C;
	constexpr uint32_t m_Lerp = 0x820;
	constexpr uint32_t m_bNormalizedOutput = 0x978;
}

namespace C_OP_DragRelativeToPlane
{
	constexpr uint32_t m_flDragAtPlane = 0x1C0;
	constexpr uint32_t m_flFalloff = 0x318;
	constexpr uint32_t m_bDirectional = 0x470;
	constexpr uint32_t m_vecPlaneNormal = 0x478;
	constexpr uint32_t m_nControlPointNumber = 0xAD0;
}
...
{
	constexpr uint32_t m_nMinCol = 0x1C0;
	constexpr uint32_t m_nMaxCol = 0x1C4;
	constexpr uint32_t m_nMinRow = 0x1C8;
	constexpr uint32_t m_nMaxRow = 0x1CC;
	constexpr uint32_t m_nControlPoint = 0x1D0;
	constexpr uint32_t m_flBlendValue = 0x1D4;
}

namespace C_OP_RemapDistanceToLineSegmentBase
{
	constexpr uint32_t m_nCP0 = 0x1C0;
	constexpr uint32_t m_nCP1 = 0x1C4;
	constexpr uint32_t m_flMinInputValue = 0x1C8;
	constexpr uint32_t m_flMaxInputValue = 0x1CC;
	constexpr uint32_t m_bInfiniteLine = 0x1D0;
}

namespace C_OP_RemapDistanceToLineSegmentToScalar
{
	constexpr uint32_t m_nFieldOutput = 0x1E0;
	constexpr uint32_t m_flMinOutputValue = 0x1E4;
	constexpr uint32_t m_flMaxOutputValue = 0x1E8;
}

namespace C_OP_RemapDistanceToLineSegmentToVector
{
	constexpr uint32_t m_nFieldOutput = 0x1E0;
	constexpr uint32_t m_vMinOutputValue = 0x1E4;
	constexpr uint32_t m_vMaxOutputValue = 0x1F0;
}

namespace C_OP_TeleportBeam
{
	constexpr uint32_t m_nCPPosition = 0x1C0;
	constexpr uint32_t m_nCPVelocity = 0x1C4;
	constexpr uint32_t m_nCPMisc = 0x1C8;
	constexpr uint32_t m_nCPColor = 0x1CC;
	constexpr uint32_t m_nCPInvalidColor = 0x1D0;
	constexpr uint32_t m_nCPExtraArcData = 0x1D4;
	constexpr uint32_t m_vGravity = 0x1D8;
	constexpr uint32_t m_flArcMaxDuration = 0x1E4;
	constexpr uint32_t m_flSegmentBreak = 0x1E8;
	constexpr uint32_t m_flArcSpeed = 0x1EC;
	constexpr uint32_t m_flAlpha = 0x1F0;
}

namespace C_OP_CycleScalar
{
	constexpr uint32_t m_nDestField = 0x1C0;
	constexpr uint32_t m_flStartValue = 0x1C4;
	constexpr uint32_t m_flEndValue = 0x1C8;
	constexpr uint32_t m_flCycleTime = 0x1CC;
	constexpr uint32_t m_bDoNotRepeatCycle = 0x1D0;
	constexpr uint32_t m_bSynchronizeParticles = 0x1D1;
	constexpr uint32_t m_nCPScale = 0x1D4;
	constexpr uint32_t m_nCPFieldMin = 0x1D8;
	constexpr uint32_t m_nCPFieldMax = 0x1DC;
	constexpr uint32_t m_nSetMethod = 0x1E0;
}

namespace C_OP_CalculateVectorAttribute
{
	constexpr uint32_t m_vStartValue = 0x1C0;
	constexpr uint32_t m_nFieldInput1 = 0x1CC;
	constexpr uint32_t m_flInputScale1 = 0x1D0;
	constexpr uint32_t m_nFieldInput2 = 0x1D4;
	constexpr uint32_t m_flInputScale2 = 0x1D8;
	constexpr uint32_t m_nControlPointInput1 = 0x1DC;
	constexpr uint32_t m_flControlPointScale1 = 0x1F0;
	constexpr uint32_t m_nControlPointInput2 = 0x1F4;
	constexpr uint32_t m_flControlPointScale2 = 0x208;
	constexpr uint32_t m_nFieldOutput = 0x20C;
	constexpr uint32_t m_vFinalOutputScale = 0x210;
}

namespace C_OP_ColorAdjustHSL
{
	constexpr uint32_t m_flHueAdjust = 0x1C0;
	constexpr uint32_t m_flSaturationAdjust = 0x318;
	constexpr uint32_t m_flLightnessAdjust = 0x470;
}

namespace C_OP_ConnectParentParticleToNearest
{
	constexpr uint32_t m_nFirstControlPoint = 0x1C0;
	constexpr uint32_t m_nSecondControlPoint = 0x1C4;
	constexpr uint32_t m_bUseRadius = 0x1C8;
	constexpr uint32_t m_flRadiusScale = 0x1D0;
	constexpr uint32_t m_flParentRadiusScale = 0x328;
}

namespace C_OP_UpdateLightSource
{
	constexpr uint32_t m_vColorTint = 0x1C0;
	constexpr uint32_t m_flBrightnessScale = 0x1C4;
	constexpr uint32_t m_flRadiusScale = 0x1C8;
	constexpr uint32_t m_flMinimumLightingRadius = 0x1CC;
	constexpr uint32_t m_flMaximumLightingRadius = 0x1D0;
	constexpr uint32_t m_flPositionDampingConstant = 0x1D4;
}

namespace C_OP_RemapSpeedtoCP
{
	constexpr uint32_t m_nInControlPointNumber = 0x1D0;
	constexpr uint32_t m_nOutControlPointNumber = 0x1D4;
	constexpr uint32_t m_nField = 0x1D8;
	constexpr uint32_t m_flInputMin = 0x1DC;
	constexpr uint32_t m_flInputMax = 0x1E0;
	constexpr uint32_t m_flOutputMin = 0x1E4;
	constexpr uint32_t m_flOutputMax = 0x1E8;
	constexpr uint32_t m_bUseDeltaV = 0x1EC;
}
...
namespace C_OP_RemapAverageHitboxSpeedtoCP
{
	...
	constexpr uint32_t m_nOutControlPointNumber = 0x1D4;
	constexpr uint32_t m_nField = 0x1D8;
	constexpr uint32_t m_nHitboxDataType = 0x1DC;
	constexpr uint32_t m_flInputMin = 0x1E0;
	constexpr uint32_t m_flInputMax = 0x338;
	constexpr uint32_t m_flOutputMin = 0x490;
	constexpr uint32_t m_flOutputMax = 0x5E8;
	constexpr uint32_t m_nHeightControlPointNumber = 0x740;
	constexpr uint32_t m_vecComparisonVelocity = 0x748;
	constexpr uint32_t m_HitboxSetName = 0xDA0;
}

namespace C_OP_RemapDotProductToCP
{
	constexpr uint32_t m_nInputCP1 = 0x1D0;
	constexpr uint32_t m_nInputCP2 = 0x1D4;
	constexpr uint32_t m_nOutputCP = 0x1D8;
	constexpr uint32_t m_nOutVectorField = 0x1DC;
	constexpr uint32_t m_flInputMin = 0x1E0;
	constexpr uint32_t m_flInputMax = 0x338;
	constexpr uint32_t m_flOutputMin = 0x490;
	constexpr uint32_t m_flOutputMax = 0x5E8;
...
{
	constexpr uint32_t m_nExpression = 0x1D0;
	constexpr uint32_t m_flInput1 = 0x1D8;
	constexpr uint32_t m_flInput2 = 0x330;
	constexpr uint32_t m_flOutputRemap = 0x488;
	constexpr uint32_t m_nOutputCP = 0x5E0;
	constexpr uint32_t m_nOutVectorField = 0x5E4;
}

namespace C_OP_SetControlPointFieldFromVectorExpression
{
	constexpr uint32_t m_nExpression = 0x1D0;
	constexpr uint32_t m_vecInput1 = 0x1D8;
	constexpr uint32_t m_vecInput2 = 0x830;
	constexpr uint32_t m_flOutputRemap = 0xE88;
	constexpr uint32_t m_nOutputCP = 0xFE0;
	constexpr uint32_t m_nOutVectorField = 0xFE4;
}

namespace C_OP_SetControlPointToVectorExpression
{
	constexpr uint32_t m_nExpression = 0x1D0;
	constexpr uint32_t m_nOutputCP = 0x1D4;
	constexpr uint32_t m_vInput1 = 0x1D8;
	constexpr uint32_t m_vInput2 = 0x830;
	constexpr uint32_t m_bNormalizedOutput = 0xE88;
}

namespace C_OP_RemapModelVolumetoCP
{
	constexpr uint32_t m_nBBoxType = 0x1D0;
	constexpr uint32_t m_nInControlPointNumber = 0x1D4;
	constexpr uint32_t m_nOutControlPointNumber = 0x1D8;
	constexpr uint32_t m_nOutControlPointMaxNumber = 0x1DC;
	constexpr uint32_t m_nField = 0x1E0;
	constexpr uint32_t m_flInputMin = 0x1E4;
	constexpr uint32_t m_flInputMax = 0x1E8;
	constexpr uint32_t m_flOutputMin = 0x1EC;
	constexpr uint32_t m_flOutputMax = 0x1F0;
}

namespace C_OP_RemapBoundingVolumetoCP
{
	constexpr uint32_t m_nOutControlPointNumber = 0x1D0;
...
{
	constexpr uint32_t m_nOutControlPointNumber = 0x1D0;
	constexpr uint32_t m_nOutVectorField = 0x1D4;
	constexpr uint32_t m_nField = 0x1D8;
	constexpr uint32_t m_flInputMin = 0x1DC;
	constexpr uint32_t m_flInputMax = 0x1E0;
	constexpr uint32_t m_flOutputMin = 0x1E4;
...
{
	constexpr uint32_t m_nOutControlPointNumber = 0x1D0;
	constexpr uint32_t m_vecRateMin = 0x1D4;
	constexpr uint32_t m_vecRateMax = 0x1E0;
}

namespace C_OP_SetParentControlPointsToChildCP
{
	constexpr uint32_t m_nChildGroupID = 0x1D0;
	constexpr uint32_t m_nChildControlPoint = 0x1D4;
	constexpr uint32_t m_nNumControlPoints = 0x1D8;
	constexpr uint32_t m_nFirstSourcePoint = 0x1DC;
	constexpr uint32_t m_bSetOrientation = 0x1E0;
}

namespace C_OP_SetVariable
{
	constexpr uint32_t m_variableReference = 0x1D0;
	constexpr uint32_t m_transformInput = 0x210;
	constexpr uint32_t m_positionOffset = 0x278;
	constexpr uint32_t m_rotationOffset = 0x284;
	constexpr uint32_t m_vecInput = 0x290;
	constexpr uint32_t m_floatInput = 0x8E8;
}

namespace C_OP_SetControlPointPositions
{
	constexpr uint32_t m_bUseWorldLocation = 0x1D0;
	constexpr uint32_t m_bOrient = 0x1D1;
	constexpr uint32_t m_bSetOnce = 0x1D2;
	constexpr uint32_t m_nCP1 = 0x1D4;
	constexpr uint32_t m_nCP2 = 0x1D8;
	constexpr uint32_t m_nCP3 = 0x1DC;
	constexpr uint32_t m_nCP4 = 0x1E0;
	constexpr uint32_t m_vecCP1Pos = 0x1E4;
	constexpr uint32_t m_vecCP2Pos = 0x1F0;
	constexpr uint32_t m_vecCP3Pos = 0x1FC;
	constexpr uint32_t m_vecCP4Pos = 0x208;
	constexpr uint32_t m_nHeadLocation = 0x214;
}
...
namespace C_OP_SetSingleControlPointPosition
{
	...
	constexpr uint32_t m_nCP1 = 0x1D4;
	constexpr uint32_t m_vecCP1Pos = 0x1D8;
	constexpr uint32_t m_transformInput = 0x830;
}

namespace C_OP_SetControlPointPositionToRandomActiveCP
{
	constexpr uint32_t m_nCP1 = 0x1D0;
	constexpr uint32_t m_nHeadLocationMin = 0x1D4;
	constexpr uint32_t m_nHeadLocationMax = 0x1D8;
	constexpr uint32_t m_flResetRate = 0x1E0;
}
...
namespace C_OP_SetRandomControlPointPosition
{
	...
	constexpr uint32_t m_bOrient = 0x1D1;
	constexpr uint32_t m_nCP1 = 0x1D4;
	constexpr uint32_t m_nHeadLocation = 0x1D8;
	constexpr uint32_t m_flReRandomRate = 0x1E0;
	constexpr uint32_t m_vecCPMinPos = 0x338;
	constexpr uint32_t m_vecCPMaxPos = 0x344;
	constexpr uint32_t m_flInterpolation = 0x350;
}

namespace C_OP_SetControlPointOrientation
{
	constexpr uint32_t m_bUseWorldLocation = 0x1D0;
	constexpr uint32_t m_bRandomize = 0x1D2;
	constexpr uint32_t m_bSetOnce = 0x1D3;
	constexpr uint32_t m_nCP = 0x1D4;
	constexpr uint32_t m_nHeadLocation = 0x1D8;
	constexpr uint32_t m_vecRotation = 0x1DC;
	constexpr uint32_t m_vecRotationB = 0x1E8;
	constexpr uint32_t m_flInterpolation = 0x1F8;
}

namespace C_OP_SetControlPointFromObjectScale
{
	constexpr uint32_t m_nCPInput = 0x1D0;
	constexpr uint32_t m_nCPOutput = 0x1D4;
}

namespace C_OP_DistanceBetweenCPsToCP
{
	constexpr uint32_t m_nStartCP = 0x1D0;
	constexpr uint32_t m_nEndCP = 0x1D4;
	constexpr uint32_t m_nOutputCP = 0x1D8;
	constexpr uint32_t m_nOutputCPField = 0x1DC;
	constexpr uint32_t m_bSetOnce = 0x1E0;
	constexpr uint32_t m_flInputMin = 0x1E4;
	constexpr uint32_t m_flInputMax = 0x1E8;
	constexpr uint32_t m_flOutputMin = 0x1EC;
	constexpr uint32_t m_flOutputMax = 0x1F0;
	constexpr uint32_t m_flMaxTraceLength = 0x1F4;
	constexpr uint32_t m_flLOSScale = 0x1F8;
	constexpr uint32_t m_bLOS = 0x1FC;
	constexpr uint32_t m_CollisionGroupName = 0x1FD;
	constexpr uint32_t m_nTraceSet = 0x280;
	constexpr uint32_t m_nSetParent = 0x284;
}
...
namespace C_OP_SetControlPointToPlayer
{
	...
	constexpr uint32_t m_bOrientToEyes = 0x1E0;
}

namespace C_OP_SetControlPointToHand
{
	constexpr uint32_t m_nCP1 = 0x1D0;
	constexpr uint32_t m_nHand = 0x1D4;
	constexpr uint32_t m_vecCP1Pos = 0x1D8;
	constexpr uint32_t m_bOrientToHand = 0x1E4;
}
...
namespace C_OP_SetControlPointToHMD
{
	constexpr uint32_t m_nCP1 = 0x1D0;
	constexpr uint32_t m_vecCP1Pos = 0x1D4;
	constexpr uint32_t m_bOrientToHMD = 0x1E0;
}

namespace C_OP_SetControlPointPositionToTimeOfDayValue
{
	constexpr uint32_t m_nControlPointNumber = 0x1D0;
	constexpr uint32_t m_pszTimeOfDayParameter = 0x1D4;
	constexpr uint32_t m_vecDefaultValue = 0x254;
}
...
namespace C_OP_SetControlPointToCenter
{
	constexpr uint32_t m_nCP1 = 0x1D0;
	constexpr uint32_t m_vecCP1Pos = 0x1D4;
	constexpr uint32_t m_nSetParent = 0x1E0;
}

namespace C_OP_SetControlPointToCPVelocity
{
	constexpr uint32_t m_nCPInput = 0x1D0;
	constexpr uint32_t m_nCPOutputVel = 0x1D4;
	constexpr uint32_t m_bNormalize = 0x1D8;
	constexpr uint32_t m_nCPOutputMag = 0x1DC;
	constexpr uint32_t m_nCPField = 0x1E0;
	constexpr uint32_t m_vecComparisonVelocity = 0x1E8;
}
...
{
	constexpr uint32_t m_flDuration = 0x1D0;
	constexpr uint32_t m_bDestroyImmediately = 0x328;
	constexpr uint32_t m_bPlayEndCap = 0x329;
}

namespace C_OP_SetControlPointRotation
{
	constexpr uint32_t m_vecRotAxis = 0x1D0;
	constexpr uint32_t m_flRotRate = 0x828;
	constexpr uint32_t m_nCP = 0x980;
	constexpr uint32_t m_nLocalCP = 0x984;
}

namespace C_OP_RemapCPtoCP
{
	constexpr uint32_t m_nInputControlPoint = 0x1D0;
	constexpr uint32_t m_nOutputControlPoint = 0x1D4;
	constexpr uint32_t m_nInputField = 0x1D8;
	constexpr uint32_t m_nOutputField = 0x1DC;
	constexpr uint32_t m_flInputMin = 0x1E0;
	constexpr uint32_t m_flInputMax = 0x1E4;
	constexpr uint32_t m_flOutputMin = 0x1E8;
	constexpr uint32_t m_flOutputMax = 0x1EC;
	constexpr uint32_t m_bDerivative = 0x1F0;
	constexpr uint32_t m_flInterpRate = 0x1F4;
}

namespace C_OP_HSVShiftToCP
{
	constexpr uint32_t m_nColorCP = 0x1D0;
	constexpr uint32_t m_nColorGemEnableCP = 0x1D4;
	constexpr uint32_t m_nOutputCP = 0x1D8;
	constexpr uint32_t m_DefaultHSVColor = 0x1DC;
}

namespace C_OP_SetControlPointToImpactPoint
{
	constexpr uint32_t m_nCPOut = 0x1D0;
	constexpr uint32_t m_nCPIn = 0x1D4;
	constexpr uint32_t m_flUpdateRate = 0x1D8;
	constexpr uint32_t m_flTraceLength = 0x1E0;
	constexpr uint32_t m_flStartOffset = 0x338;
	constexpr uint32_t m_flOffset = 0x33C;
	constexpr uint32_t m_vecTraceDir = 0x340;
	constexpr uint32_t m_CollisionGroupName = 0x34C;
	constexpr uint32_t m_nTraceSet = 0x3CC;
	constexpr uint32_t m_bSetToEndpoint = 0x3D0;
	constexpr uint32_t m_bTraceToClosestSurface = 0x3D1;
	constexpr uint32_t m_bIncludeWater = 0x3D2;
}

namespace C_OP_SetCPOrientationToPointAtCP
{
	constexpr uint32_t m_nInputCP = 0x1D0;
	constexpr uint32_t m_nOutputCP = 0x1D4;
	constexpr uint32_t m_flInterpolation = 0x1D8;
	constexpr uint32_t m_b2DOrientation = 0x330;
	constexpr uint32_t m_bAvoidSingularity = 0x331;
	constexpr uint32_t m_bPointAway = 0x332;
}

namespace C_OP_EnableChildrenFromParentParticleCount
{
	constexpr uint32_t m_nChildGroupID = 0x1D0;
	constexpr uint32_t m_nFirstChild = 0x1D4;
	constexpr uint32_t m_nNumChildrenToEnable = 0x1D8;
	constexpr uint32_t m_bDisableChildren = 0x330;
	constexpr uint32_t m_bPlayEndcapOnStop = 0x331;
	constexpr uint32_t m_bDestroyImmediately = 0x332;
}

namespace C_OP_SelectivelyEnableChildren
{
	constexpr uint32_t m_nChildGroupID = 0x1D0;
	constexpr uint32_t m_nFirstChild = 0x328;
	constexpr uint32_t m_nNumChildrenToEnable = 0x480;
	constexpr uint32_t m_bPlayEndcapOnStop = 0x5D8;
	constexpr uint32_t m_bDestroyImmediately = 0x5D9;
}

namespace C_OP_PlayEndCapWhenFinished
{
	constexpr uint32_t m_bFireOnEmissionEnd = 0x1D0;
	constexpr uint32_t m_bIncludeChildren = 0x1D1;
}

namespace C_OP_ForceControlPointStub
{
	constexpr uint32_t m_ControlPoint = 0x1D0;
}

namespace C_OP_DriveCPFromGlobalSoundFloat
{
	constexpr uint32_t m_nOutputControlPoint = 0x1D0;
	constexpr uint32_t m_nOutputField = 0x1D4;
	constexpr uint32_t m_flInputMin = 0x1D8;
	constexpr uint32_t m_flInputMax = 0x1DC;
	constexpr uint32_t m_flOutputMin = 0x1E0;
	constexpr uint32_t m_flOutputMax = 0x1E4;
	constexpr uint32_t m_StackName = 0x1E8;
	constexpr uint32_t m_OperatorName = 0x1F0;
	constexpr uint32_t m_FieldName = 0x1F8;
}

namespace C_OP_SetControlPointFieldToWater
{
	constexpr uint32_t m_nSourceCP = 0x1D0;
	constexpr uint32_t m_nDestCP = 0x1D4;
	constexpr uint32_t m_nCPField = 0x1D8;
}
...
namespace C_OP_SetControlPointToWaterSurface
{
	constexpr uint32_t m_nSourceCP = 0x1D0;
	constexpr uint32_t m_nDestCP = 0x1D4;
	constexpr uint32_t m_nFlowCP = 0x1D8;
	constexpr uint32_t m_nActiveCP = 0x1DC;
	constexpr uint32_t m_nActiveCPField = 0x1E0;
	constexpr uint32_t m_flRetestRate = 0x1E8;
	constexpr uint32_t m_bAdaptiveThreshold = 0x340;
}

namespace C_OP_RepeatedTriggerChildGroup
{
	constexpr uint32_t m_nChildGroupID = 0x1D0;
	constexpr uint32_t m_flClusterRefireTime = 0x1D8;
	constexpr uint32_t m_flClusterSize = 0x330;
	constexpr uint32_t m_flClusterCooldown = 0x488;
	constexpr uint32_t m_bLimitChildCount = 0x5E0;
}

namespace C_OP_ChooseRandomChildrenInGroup
{
	constexpr uint32_t m_nChildGroupID = 0x1D0;
	constexpr uint32_t m_flNumberOfChildren = 0x1D8;
}

namespace C_OP_SetSimulationRate
{
	constexpr uint32_t m_flSimulationScale = 0x1D0;
}

namespace C_OP_ControlPointToRadialScreenSpace
{
	constexpr uint32_t m_nCPIn = 0x1D0;
	constexpr uint32_t m_vecCP1Pos = 0x1D4;
	constexpr uint32_t m_nCPOut = 0x1E0;
	constexpr uint32_t m_nCPOutField = 0x1E4;
	constexpr uint32_t m_nCPSSPosOut = 0x1E8;
}

namespace C_OP_LightningSnapshotGenerator
{
	constexpr uint32_t m_nCPSnapshot = 0x1D0;
	constexpr uint32_t m_nCPStartPnt = 0x1D4;
	constexpr uint32_t m_nCPEndPnt = 0x1D8;
	constexpr uint32_t m_flSegments = 0x1E0;
	constexpr uint32_t m_flOffset = 0x338;
	constexpr uint32_t m_flOffsetDecay = 0x490;
	constexpr uint32_t m_flRecalcRate = 0x5E8;
	constexpr uint32_t m_flUVScale = 0x740;
	constexpr uint32_t m_flUVOffset = 0x898;
	constexpr uint32_t m_flSplitRate = 0x9F0;
	constexpr uint32_t m_flBranchTwist = 0xB48;
	constexpr uint32_t m_nBranchBehavior = 0xCA0;
	constexpr uint32_t m_flRadiusStart = 0xCA8;
	constexpr uint32_t m_flRadiusEnd = 0xE00;
	constexpr uint32_t m_flDedicatedPool = 0xF58;
}
...
namespace C_OP_RemapExternalWindToCP
{
	constexpr uint32_t m_nCP = 0x1D0;
	constexpr uint32_t m_nCPOutput = 0x1D4;
	constexpr uint32_t m_vecScale = 0x1D8;
	constexpr uint32_t m_bSetMagnitude = 0x830;
	constexpr uint32_t m_nOutVectorField = 0x834;
}
...
namespace C_OP_SetGravityToCP
{
	...
	constexpr uint32_t m_nCPOutput = 0x1D4;
	constexpr uint32_t m_flScale = 0x1D8;
	constexpr uint32_t m_bSetOrientation = 0x330;
	constexpr uint32_t m_bSetZDown = 0x331;
}

namespace C_OP_QuantizeCPComponent
{
	constexpr uint32_t m_flInputValue = 0x1D0;
	constexpr uint32_t m_nCPOutput = 0x328;
	constexpr uint32_t m_nOutVectorField = 0x32C;
	constexpr uint32_t m_flQuantizeValue = 0x330;
}

namespace C_OP_RenderPoints
{
	constexpr uint32_t m_hMaterial = 0x200;
}

namespace CBaseTrailRenderer
{
	constexpr uint32_t m_nOrientationType = 0x2710;
	constexpr uint32_t m_nOrientationControlPoint = 0x2714;
	constexpr uint32_t m_flMinSize = 0x2718;
	constexpr uint32_t m_flMaxSize = 0x271C;
	constexpr uint32_t m_flStartFadeSize = 0x2720;
	constexpr uint32_t m_flEndFadeSize = 0x2878;
	constexpr uint32_t m_bClampV = 0x29D0;
}
...
{
	constexpr uint32_t m_bEnableFadingAndClamping = 0x2710;
	constexpr uint32_t m_flMinSize = 0x2714;
	constexpr uint32_t m_flMaxSize = 0x2718;
	constexpr uint32_t m_flStartFadeSize = 0x271C;
	constexpr uint32_t m_flEndFadeSize = 0x2720;
	constexpr uint32_t m_flStartFadeDot = 0x2724;
	constexpr uint32_t m_flEndFadeDot = 0x2728;
	constexpr uint32_t m_flRadiusTaper = 0x272C;
	constexpr uint32_t m_nMinTesselation = 0x2730;
	constexpr uint32_t m_nMaxTesselation = 0x2734;
	constexpr uint32_t m_flTessScale = 0x2738;
	constexpr uint32_t m_flTextureVWorldSize = 0x2740;
	constexpr uint32_t m_flTextureVScrollRate = 0x2898;
	constexpr uint32_t m_flTextureVOffset = 0x29F0;
	constexpr uint32_t m_nTextureVParamsCP = 0x2B48;
	constexpr uint32_t m_bClampV = 0x2B4C;
	constexpr uint32_t m_nScaleCP1 = 0x2B50;
	constexpr uint32_t m_nScaleCP2 = 0x2B54;
	constexpr uint32_t m_flScaleVSizeByControlPointDistance = 0x2B58;
	constexpr uint32_t m_flScaleVScrollByControlPointDistance = 0x2B5C;
	constexpr uint32_t m_flScaleVOffsetByControlPointDistance = 0x2B60;
	constexpr uint32_t m_bUseScalarForTextureCoordinate = 0x2B65;
	constexpr uint32_t m_nScalarFieldForTextureCoordinate = 0x2B68;
	constexpr uint32_t m_flScalarAttributeTextureCoordScale = 0x2B6C;
	constexpr uint32_t m_bReverseOrder = 0x2B70;
	constexpr uint32_t m_bClosedLoop = 0x2B71;
	constexpr uint32_t m_nOrientationType = 0x2B74;
	constexpr uint32_t m_nVectorFieldForOrientation = 0x2B78;
	constexpr uint32_t m_bDrawAsOpaque = 0x2B7C;
	constexpr uint32_t m_bGenerateNormals = 0x2B7D;
}

namespace C_OP_RenderAsModels
{
	constexpr uint32_t m_ModelList = 0x200;
	constexpr uint32_t m_flModelScale = 0x21C;
	constexpr uint32_t m_bFitToModelSize = 0x220;
	constexpr uint32_t m_bNonUniformScaling = 0x221;
	constexpr uint32_t m_nXAxisScalingAttribute = 0x224;
	constexpr uint32_t m_nYAxisScalingAttribute = 0x228;
	constexpr uint32_t m_nZAxisScalingAttribute = 0x22C;
	constexpr uint32_t m_nSizeCullBloat = 0x230;
}
...
{
	constexpr uint32_t m_cubeWidth = 0x200;
	constexpr uint32_t m_cutoffRadius = 0x358;
	constexpr uint32_t m_renderRadius = 0x4B0;
	constexpr uint32_t m_nScaleCP = 0x608;
	constexpr uint32_t m_MaterialVars = 0x610;
	constexpr uint32_t m_hMaterial = 0x640;
}

namespace C_OP_RenderGpuImplicit
{
	constexpr uint32_t m_bUsePerParticleRadius = 0x200;
	constexpr uint32_t m_fGridSize = 0x208;
	constexpr uint32_t m_fRadiusScale = 0x360;
	constexpr uint32_t m_fIsosurfaceThreshold = 0x4B8;
	constexpr uint32_t m_nScaleCP = 0x610;
	constexpr uint32_t m_hMaterial = 0x618;
}

namespace C_OP_RenderScreenVelocityRotate
{
	constexpr uint32_t m_flRotateRateDegrees = 0x200;
	constexpr uint32_t m_flForwardDegrees = 0x204;
}

namespace C_OP_RenderModels
{
	constexpr uint32_t m_bOnlyRenderInEffectsBloomPass = 0x200;
	constexpr uint32_t m_bOnlyRenderInEffectsWaterPass = 0x201;
	constexpr uint32_t m_bUseMixedResolutionRendering = 0x202;
	constexpr uint32_t m_bOnlyRenderInEffecsGameOverlay = 0x203;
	constexpr uint32_t m_ModelList = 0x208;
	constexpr uint32_t m_nBodyGroupField = 0x224;
	constexpr uint32_t m_nSubModelField = 0x228;
	constexpr uint32_t m_bIgnoreNormal = 0x22C;
	constexpr uint32_t m_bOrientZ = 0x22D;
	constexpr uint32_t m_bCenterOffset = 0x22E;
	constexpr uint32_t m_vecLocalOffset = 0x230;
	constexpr uint32_t m_vecLocalRotation = 0x888;
	constexpr uint32_t m_bIgnoreRadius = 0xEE0;
	constexpr uint32_t m_nModelScaleCP = 0xEE4;
	constexpr uint32_t m_vecComponentScale = 0xEE8;
	constexpr uint32_t m_bLocalScale = 0x1540;
	constexpr uint32_t m_nSizeCullBloat = 0x1544;
	constexpr uint32_t m_bAnimated = 0x1548;
	constexpr uint32_t m_flAnimationRate = 0x1550;
	constexpr uint32_t m_bScaleAnimationRate = 0x16A8;
	constexpr uint32_t m_bForceLoopingAnimation = 0x16A9;
	constexpr uint32_t m_bResetAnimOnStop = 0x16AA;
	constexpr uint32_t m_bManualAnimFrame = 0x16AB;
	constexpr uint32_t m_nAnimationScaleField = 0x16AC;
	constexpr uint32_t m_nAnimationField = 0x16B0;
	constexpr uint32_t m_nManualFrameField = 0x16B4;
	constexpr uint32_t m_ActivityName = 0x16B8;
	constexpr uint32_t m_SequenceName = 0x17B8;
	constexpr uint32_t m_bEnableClothSimulation = 0x18B8;
	constexpr uint32_t m_hOverrideMaterial = 0x18C0;
	constexpr uint32_t m_bOverrideTranslucentMaterials = 0x18C8;
	constexpr uint32_t m_nSkin = 0x18D0;
	constexpr uint32_t m_MaterialVars = 0x1A28;
	constexpr uint32_t m_flManualModelSelection = 0x1A40;
	constexpr uint32_t m_modelInput = 0x1B98;
	constexpr uint32_t m_nLOD = 0x1BF8;
	constexpr uint32_t m_EconSlotName = 0x1BFC;
	constexpr uint32_t m_bOriginalModel = 0x1CFC;
	constexpr uint32_t m_bSuppressTint = 0x1CFD;
	constexpr uint32_t m_bUseRawMeshGroup = 0x1CFE;
	constexpr uint32_t m_bDisableShadows = 0x1CFF;
	constexpr uint32_t m_bDisableDepthPrepass = 0x1D00;
	constexpr uint32_t m_bAcceptsDecals = 0x1D01;
	constexpr uint32_t m_bForceDrawInterlevedWithSiblings = 0x1D02;
	constexpr uint32_t m_bDoNotDrawInParticlePass = 0x1D03;
	constexpr uint32_t m_bUseFastModelCollectionRenderPath = 0x1D04;
	constexpr uint32_t m_bAllowApproximateTransforms = 0x1D05;
	constexpr uint32_t m_szRenderAttribute = 0x1D06;
	constexpr uint32_t m_flRadiusScale = 0x1E10;
	constexpr uint32_t m_flAlphaScale = 0x1F68;
	constexpr uint32_t m_flRollScale = 0x20C0;
	constexpr uint32_t m_nAlpha2Field = 0x2218;
	constexpr uint32_t m_vecColorScale = 0x2220;
	constexpr uint32_t m_nColorBlendType = 0x2878;
}

namespace C_OP_RenderSimpleModelCollection
{
	constexpr uint32_t m_bCenterOffset = 0x200;
	constexpr uint32_t m_modelInput = 0x208;
	constexpr uint32_t m_nLOD = 0x268;
	constexpr uint32_t m_bDisableShadows = 0x26C;
	constexpr uint32_t m_bAcceptsDecals = 0x26D;
}

namespace C_OP_RenderMaterialProxy
{
	constexpr uint32_t m_nMaterialControlPoint = 0x200;
	constexpr uint32_t m_nProxyType = 0x204;
	constexpr uint32_t m_MaterialVars = 0x208;
	constexpr uint32_t m_hOverrideMaterial = 0x220;
	constexpr uint32_t m_flMaterialOverrideEnabled = 0x228;
	constexpr uint32_t m_vecColorScale = 0x380;
	constexpr uint32_t m_flAlpha = 0x9D8;
	constexpr uint32_t m_nColorBlendType = 0xB30;
}

namespace C_OP_RenderProjected
{
	constexpr uint32_t m_bProjectCharacter = 0x200;
	constexpr uint32_t m_bProjectWorld = 0x201;
	constexpr uint32_t m_bProjectWater = 0x202;
	constexpr uint32_t m_bFlipHorizontal = 0x203;
	constexpr uint32_t m_bEnableProjectedDepthControls = 0x204;
	constexpr uint32_t m_flMinProjectionDepth = 0x208;
	constexpr uint32_t m_flMaxProjectionDepth = 0x20C;
	constexpr uint32_t m_vecProjectedMaterials = 0x210;
	constexpr uint32_t m_flMaterialSelection = 0x228;
	constexpr uint32_t m_flAnimationTimeScale = 0x380;
	constexpr uint32_t m_bOrientToNormal = 0x384;
	constexpr uint32_t m_MaterialVars = 0x388;
}

namespace C_OP_RenderDeferredLight
{
	constexpr uint32_t m_bUseAlphaTestWindow = 0x200;
	constexpr uint32_t m_bUseTexture = 0x201;
	constexpr uint32_t m_flRadiusScale = 0x204;
	constexpr uint32_t m_flAlphaScale = 0x208;
	constexpr uint32_t m_nAlpha2Field = 0x20C;
	constexpr uint32_t m_vecColorScale = 0x210;
	constexpr uint32_t m_nColorBlendType = 0x868;
	constexpr uint32_t m_flLightDistance = 0x86C;
	constexpr uint32_t m_flStartFalloff = 0x870;
	constexpr uint32_t m_flDistanceFalloff = 0x874;
	constexpr uint32_t m_flSpotFoV = 0x878;
	constexpr uint32_t m_nAlphaTestPointField = 0x87C;
	constexpr uint32_t m_nAlphaTestRangeField = 0x880;
	constexpr uint32_t m_nAlphaTestSharpnessField = 0x884;
	constexpr uint32_t m_hTexture = 0x888;
	constexpr uint32_t m_nHSVShiftControlPoint = 0x890;
}

namespace C_OP_RenderStandardLight
{
	constexpr uint32_t m_nLightType = 0x200;
	constexpr uint32_t m_vecColorScale = 0x208;
	constexpr uint32_t m_nColorBlendType = 0x860;
	constexpr uint32_t m_flIntensity = 0x868;
	constexpr uint32_t m_bCastShadows = 0x9C0;
	constexpr uint32_t m_flTheta = 0x9C8;
	constexpr uint32_t m_flPhi = 0xB20;
	constexpr uint32_t m_flRadiusMultiplier = 0xC78;
	constexpr uint32_t m_nAttenuationStyle = 0xDD0;
	constexpr uint32_t m_flFalloffLinearity = 0xDD8;
	constexpr uint32_t m_flFiftyPercentFalloff = 0xF30;
	constexpr uint32_t m_flZeroPercentFalloff = 0x1088;
	constexpr uint32_t m_bRenderDiffuse = 0x11E0;
	constexpr uint32_t m_bRenderSpecular = 0x11E1;
	constexpr uint32_t m_lightCookie = 0x11E8;
	constexpr uint32_t m_nPriority = 0x11F0;
	constexpr uint32_t m_nFogLightingMode = 0x11F4;
	constexpr uint32_t m_flFogContribution = 0x11F8;
	constexpr uint32_t m_nCapsuleLightBehavior = 0x1350;
	constexpr uint32_t m_flCapsuleLength = 0x1354;
	constexpr uint32_t m_bReverseOrder = 0x1358;
	constexpr uint32_t m_bClosedLoop = 0x1359;
	constexpr uint32_t m_nPrevPntSource = 0x135C;
	constexpr uint32_t m_flMaxLength = 0x1360;
	constexpr uint32_t m_flMinLength = 0x1364;
	constexpr uint32_t m_bIgnoreDT = 0x1368;
	constexpr uint32_t m_flConstrainRadiusToLengthRatio = 0x136C;
	constexpr uint32_t m_flLengthScale = 0x1370;
	constexpr uint32_t m_flLengthFadeInTime = 0x1374;
}
...
namespace C_OP_RenderOmni2Light
{
	...
	constexpr uint32_t m_nColorBlendType = 0x860;
	constexpr uint32_t m_nBrightnessUnit = 0x864;
	constexpr uint32_t m_flBrightnessLumens = 0x868;
	constexpr uint32_t m_flBrightnessCandelas = 0x9C0;
	constexpr uint32_t m_bCastShadows = 0xB18;
	constexpr uint32_t m_flLuminaireRadius = 0xB20;
	constexpr uint32_t m_flSkirt = 0xC78;
	constexpr uint32_t m_flRange = 0xDD0;
	constexpr uint32_t m_flInnerConeAngle = 0xF28;
	constexpr uint32_t m_flOuterConeAngle = 0x1080;
	constexpr uint32_t m_hLightCookie = 0x11D8;
	constexpr uint32_t m_bSphericalCookie = 0x11E0;
}

namespace C_OP_RenderLightBeam
{
	constexpr uint32_t m_vColorBlend = 0x200;
	constexpr uint32_t m_nColorBlendType = 0x858;
	constexpr uint32_t m_flBrightnessLumensPerMeter = 0x860;
	constexpr uint32_t m_bCastShadows = 0x9B8;
	constexpr uint32_t m_flSkirt = 0x9C0;
	constexpr uint32_t m_flRange = 0xB18;
	constexpr uint32_t m_flThickness = 0xC70;
}
...
{
	constexpr uint32_t m_flDurationScale = 0x200;
	constexpr uint32_t m_flRadiusScale = 0x204;
	constexpr uint32_t m_flFrequencyScale = 0x208;
	constexpr uint32_t m_flAmplitudeScale = 0x20C;
	constexpr uint32_t m_nRadiusField = 0x210;
	constexpr uint32_t m_nDurationField = 0x214;
	constexpr uint32_t m_nFrequencyField = 0x218;
	constexpr uint32_t m_nAmplitudeField = 0x21C;
	constexpr uint32_t m_nFilterCP = 0x220;
}

namespace C_OP_RenderTonemapController
{
	constexpr uint32_t m_flTonemapLevel = 0x200;
	constexpr uint32_t m_flTonemapWeight = 0x204;
	constexpr uint32_t m_nTonemapLevelField = 0x208;
	constexpr uint32_t m_nTonemapWeightField = 0x20C;
}

namespace C_OP_RenderPostProcessing
{
	constexpr uint32_t m_flPostProcessStrength = 0x200;
	constexpr uint32_t m_hPostTexture = 0x358;
	constexpr uint32_t m_nPriority = 0x360;
}

namespace C_OP_RenderSound
{
	constexpr uint32_t m_flDurationScale = 0x200;
	constexpr uint32_t m_flSndLvlScale = 0x204;
	constexpr uint32_t m_flPitchScale = 0x208;
	constexpr uint32_t m_flVolumeScale = 0x20C;
	constexpr uint32_t m_nSndLvlField = 0x210;
	constexpr uint32_t m_nDurationField = 0x214;
	constexpr uint32_t m_nPitchField = 0x218;
	constexpr uint32_t m_nVolumeField = 0x21C;
	constexpr uint32_t m_nChannel = 0x220;
	constexpr uint32_t m_nCPReference = 0x224;
	constexpr uint32_t m_pszSoundName = 0x228;
	constexpr uint32_t m_bSuppressStopSoundEvent = 0x328;
}

namespace C_OP_RenderStatusEffect
{
	constexpr uint32_t m_pTextureColorWarp = 0x200;
	constexpr uint32_t m_pTextureDetail2 = 0x208;
	constexpr uint32_t m_pTextureDiffuseWarp = 0x210;
	constexpr uint32_t m_pTextureFresnelColorWarp = 0x218;
	constexpr uint32_t m_pTextureFresnelWarp = 0x220;
	constexpr uint32_t m_pTextureSpecularWarp = 0x228;
	constexpr uint32_t m_pTextureEnvMap = 0x230;
}

namespace C_OP_RenderStatusEffectCitadel
{
	constexpr uint32_t m_pTextureColorWarp = 0x200;
	constexpr uint32_t m_pTextureNormal = 0x208;
	constexpr uint32_t m_pTextureMetalness = 0x210;
	constexpr uint32_t m_pTextureRoughness = 0x218;
	constexpr uint32_t m_pTextureSelfIllum = 0x220;
	constexpr uint32_t m_pTextureDetail = 0x228;
}

namespace C_OP_RenderFlattenGrass
{
	constexpr uint32_t m_flFlattenStrength = 0x200;
	constexpr uint32_t m_nStrengthFieldOverride = 0x204;
	constexpr uint32_t m_flRadiusScale = 0x208;
}

namespace C_OP_RenderTreeShake
{
	constexpr uint32_t m_flPeakStrength = 0x200;
	constexpr uint32_t m_nPeakStrengthFieldOverride = 0x204;
	constexpr uint32_t m_flRadius = 0x208;
	constexpr uint32_t m_nRadiusFieldOverride = 0x20C;
	constexpr uint32_t m_flShakeDuration = 0x210;
	constexpr uint32_t m_flTransitionTime = 0x214;
	constexpr uint32_t m_flTwistAmount = 0x218;
	constexpr uint32_t m_flRadialAmount = 0x21C;
	constexpr uint32_t m_flControlPointOrientationAmount = 0x220;
	constexpr uint32_t m_nControlPointForLinearDirection = 0x224;
}

namespace C_OP_RenderText
{
	constexpr uint32_t m_OutlineColor = 0x200;
	constexpr uint32_t m_DefaultText = 0x208;
}

namespace C_OP_RenderVRHapticEvent
{
	constexpr uint32_t m_nHand = 0x200;
	constexpr uint32_t m_nOutputHandCP = 0x204;
	constexpr uint32_t m_nOutputField = 0x208;
	constexpr uint32_t m_flAmplitude = 0x210;
}

namespace C_OP_RemapSDFDistanceToScalarAttribute
{
	constexpr uint32_t m_nFieldOutput = 0x1C0;
	constexpr uint32_t m_nVectorFieldInput = 0x1C4;
	constexpr uint32_t m_flMinDistance = 0x1C8;
	constexpr uint32_t m_flMaxDistance = 0x320;
	constexpr uint32_t m_flValueBelowMin = 0x478;
	constexpr uint32_t m_flValueAtMin = 0x5D0;
	constexpr uint32_t m_flValueAtMax = 0x728;
	constexpr uint32_t m_flValueAboveMax = 0x880;
}

namespace C_OP_RemapSDFDistanceToVectorAttribute
{
	constexpr uint32_t m_nVectorFieldOutput = 0x1C0;
	constexpr uint32_t m_nVectorFieldInput = 0x1C4;
	constexpr uint32_t m_flMinDistance = 0x1C8;
	constexpr uint32_t m_flMaxDistance = 0x320;
	constexpr uint32_t m_vValueBelowMin = 0x478;
	constexpr uint32_t m_vValueAtMin = 0x484;
	constexpr uint32_t m_vValueAtMax = 0x490;
	constexpr uint32_t m_vValueAboveMax = 0x49C;
}
...
{
	constexpr uint32_t m_vLightingDir = 0x1C0;
	constexpr uint32_t m_vTint_0 = 0x1CC;
	constexpr uint32_t m_vTint_1 = 0x1D8;
}

namespace C_OP_SDFConstraint
{
	constexpr uint32_t m_flMinDist = 0x1C0;
	constexpr uint32_t m_flMaxDist = 0x318;
	constexpr uint32_t m_nMaxIterations = 0x470;
}
